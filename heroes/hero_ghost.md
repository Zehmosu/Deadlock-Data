...
- **m_WeaponInfo**:
  ...
  - **m_szBulletTravelTracerParticle**: resource_name:"particles/weapon_fx/ghost/ghost_tracer.vpcf"
  - **m_szMuzzleFlashEffectName**: resource_name:"particles/weapon_fx/ghost/ghost_muzzle_flash.vpcf"
  - **m_strShootSound**: soundevent:"Ghost.Wpn.Fire"
  - **m_strBulletWhizSound**: soundevent:"Ghost.Wpn.BulletWhizby"
  ...
  - **m_bCanZoom**: True
  - **m_strWeaponImpactEffect**: resource_name:"particles/weapon_fx/ghost/ghost_tracer_impact.vpcf"
  ...
  - **m_strZoomInSound**: soundevent:"Ghost.Wpn.Zoom.In"
  - **m_strZoomOutSound**: soundevent:"Ghost.Wpn.Zoom.Out"
  ...
  - **m_StandingShootSpreadPenalty**:
    - 0.0
    - 0.5
  - **m_strBulletImpactSound**: soundevent:"Ghost.Wpn.Impact"
  - **m_flBulletDamage**: 25
- **_multibase**:
  - hero_weapon_base
...
- **m_mapAbilityProperties**:
  ...
  - **SelfDamage**:
    ...
    - **m_subclassScaleFunction**:
      - **subclass**:
        - **_class**: scale_function_single_stat
        - **_my_subclass_name**: SelfDamage_scale_function
  ...
  - **BloodSpillDuration**:
    ...
    - **m_subclassScaleFunction**:
      - **subclass**:
        - **_class**: scale_function_single_stat
        - **_my_subclass_name**: BloodSpillDuration_scale_function
        - **m_eSpecificStatScaleType**: ETechDuration
- **m_bitsPostCastEnabledStateMask**: MODIFIER_STATE_BUSY_WITH_ACTION
- **_editor**:
  - **folder_name**: Hero Ghost
...
- **m_strAbilityImage**: panorama:"file://{images}/hud/abilities/spectre/blood_bomb.psd"
...
- **m_projectileInfo**:
  - **m_flSpeed**: 1600
  - **m_flUpSpeed**: 0
  - **m_particle**: resource_name:"particles/abilities/ghost/ghost_blood_bomb_projectile.vpcf"
  - **m_warningParticle**: resource_name:"particles/abilities/ghost/ghost_blood_bomb_warning.vpcf"
  - **m_flVerticalAimBias**: 10
  - **m_nBehaviors**: PBF_StickToTarget | PBF_StickToWorld | PBF_StartDetonateTimeOnHitTarget | PBF_StartDetonateTimeOnHitWorld
  - **m_DetonateSound**: soundevent:"Ability.GhostSoldier.BloodBomb.Explode"
- **m_strCastAnimGraphParam**: b_BloodBomb
- **m_previewParticle**: resource_name:"particles/abilities/ghost/ghost_blood_bomb_preview.vpcf"
- **m_vecAbilityUpgrades**:
  | m_vecPropertyUpgrades |
  | --- |
  | [{'m_strPropertyName': 'Radius', 'm_strBonus': '2m'}] |
  | [{'m_strPropertyName': 'Damage', 'm_strBonus': '60'}] |
  | [{'m_strPropertyName': 'BloodSpillDPSPercent', 'm_strBonus': '22'}, {'m_strPropertyName': 'BloodSpillDuration', 'm_strBonus': '6'}] |
- **m_strSecondaryStatName**: ability_blood_bomb_bloodspill
- **m_strCastSound**: soundevent:"Ghost.BloodBomb.Cast"
- **m_strMoviePreviewPath**: file://{resources}/videos/hero_abilities/ghost_blood_bomb.webm
- **m_ExplodeParticle**: resource_name:"particles/abilities/ghost/ghost_blood_bomb_explode.vpcf"
- **m_SpilledBloodModifier**:
  - **subclass**:
    - **_class**: modifier_spilled_blood_thinker
    - **_my_subclass_name**: modifier_spilled_blood_thinker
    - **m_SpilledBloodParticle**: resource_name:"particles/abilities/ghost/ghost_blood_bomb_spilled_blood.vpcf"
    - **m_flTickRate**: 0.5
    - **m_flHeight**: 80.0
- **m_AbilityTooltipDetails**:
  - **m_vecAbilityInfoSections**:
    ...
    | --- | --- | --- |
    | #ability_blood_bomb_desc | [{'m_vecAbilityProperties': [{'m_strImportantProperty': 'Damage'}, {'m_strImportantProperty': 'SelfDamage'}]}] | ['ArmingDuration'] |
    | #ability_blood_bomb_t3_desc | [{'m_vecAbilityProperties': [{'m_strImportantProperty': 'BloodSpillDuration'}]}] |  |
...
- **m_HUDPanel**:
  - **m_vecButtonHints**:
    | m_strLocToken | m_eHintSide | m_strBindingOverride1 | m_strContext |
    | --- | --- | --- | --- |
    | #AbilityButtonHint_StopLifeDrain | EButtonSide_Right | in_ability2 | cancel |
  - **m_vecHUDElements**:
...
- **m_eAbilityActivation**: CITADEL_ABILITY_ACTIVATION_PRESS
- **m_strAbilityImage**: panorama:"file://{images}/hud/abilities/spectre/life_drain.psd"
...
- **m_vecAbilityUpgrades**:
  | m_vecPropertyUpgrades |
  | --- |
  | [{'m_strPropertyName': 'LifeDrainPerSecond', 'm_strBonus': '20'}] |
  | [{'m_strPropertyName': 'AbilityDuration', 'm_strBonus': '2.0'}] |
  | [{'m_strPropertyName': 'SilenceOnDrain', 'm_strBonus': '1'}] |
- **m_strCastSound**: soundevent:"Ghost.LifeDrain.Cast"
- **m_LifeDrainTargetModifier**:
  - **subclass**:
    - **_class**: modifier_life_drain
    - **_my_subclass_name**: modifier_life_drain
    - **m_DrainParticle**: resource_name:"particles/abilities/ghost/ghost_life_drain.vpcf"
    - **m_SilenceModifier**:
      - **subclass**:
...
- **m_previewParticle**: resource_name:"particles/abilities/ghost/ghost_life_drain_cast_preview.vpcf"
- **m_LifeDrainCasterModifier**:
  - **subclass**:
    - **_class**: modifier_base
    - **_my_subclass_name**: modifier_life_drain_caster
    - **m_bIsHidden**: True
    - **m_strParticleStatusEffect**: resource_name:"particles/status_fx/status_fx_ghost_lifedrain.vpcf"
    - **m_vecSetAndTrackedAnimGraphParams**:
      | m_strName | m_strSetValue | m_strRestoreValue |
      | --- | --- | --- |
      | e_LifeDrainState | casting | none |
    - **m_vecAutoRegisterModifierValueFromAbilityPropertyName**:
      - MoveSpeedReduction
- **m_vecDependentAbilities**:
  - ability_life_drain_cancel_trigger
- **m_AbilityTooltipDetails**:
  - **m_vecAbilityInfoSections**:
    | m_strLocString | m_vecAbilityPropertiesBlock | m_vecBasicProperties |
    | --- | --- | --- |
    | #ability_life_drain_desc | [{'m_strPropertiesTitleLocString': '', 'm_vecAbilityProperties': [{'m_strImportantProperty': 'LifeDrainPerSecond'}, {'m_strImportantProperty': 'StatusEffectEMP', 'm_bRequiresAbilityUpgrade': True, 'm_strStatusEffectValue': 'SilenceOnDrain'}]}] | ['MaxRange'] |
...
- **m_WeaponInfo**:
  ...
  - **m_flBulletRadius**: 30.0
  - **m_flBulletRadiusVsWorld**: 3.0
  - **m_szBulletTravelTracerParticle**: resource_name:"particles/abilities/ghost/ghost_blood_shard_dagger.vpcf"
  - **m_eAttachmentSourceType**: EAttachmentSource_Custom
  - **m_strCustomAttachmentSource**: palm_R
  - **m_strWeaponImpactEffect**: resource_name:"particles/abilities/ghost/ghost_blood_shard_dagger_impact.vpcf"
  - **m_mapImpactEffects**:
    - **default**:
  - **m_strBulletLoopingSound**: soundevent:"Ghost.BloodShards.Proj.Lp"
- **m_strCancelAbilityKey**: +in_cancel_ability
- **m_HUDPanel**:
  - **m_vecButtonHints**:
    | m_strContext | m_eButton1 | m_eHintSide | m_strLocToken |
...
- **m_eAbilityActivation**: CITADEL_ABILITY_ACTIVATION_INSTANT_CAST
- **m_nAbilityBehaviors**: CITADEL_ABILITY_BEHAVIOR_PROJECTILE | CITADEL_ABILITY_BEHAVIOR_NO_TARGET | CITADEL_ABILITY_BEHAVIOR_DONT_TRIGGER_SPELL_BLOCK | CITADEL_ABILITY_BEHAVIOR_DISPLAYS_DAMAGE_IMPACT
- **m_nAbilityTargetTypes**: CITADEL_UNIT_TARGET_ALL_ENEMY
- **m_iUpdateTime**: 1647547907
- **m_strChannelLoopSound**: soundevent:""
- **m_strCastSound**: soundevent:"Ghost.Malice.Cast"
- **m_strCastDelaySound**: soundevent:"Ghost.Malice.PreCast"
- **m_ImpactParticle**: resource_name:"particles/abilities/ghost/ghost_blood_shard_dagger_impact.vpcf"
...
- **m_vecAbilityUpgrades**:
  | m_vecPropertyUpgrades |
  | --- |
  | [{'m_strPropertyName': 'AbilityCooldown', 'm_strBonus': '-3'}] |
  | [{'m_strPropertyName': 'HealthToDamage', 'm_strBonus': '40'}] |
  | [{'m_strPropertyName': 'NumBloodShards', 'm_strBonus': '6'}, {'m_strPropertyName': 'SpreadAngleDegrees', 'm_strBonus': '22'}] |
- **m_DebuffModifier**:
  - **subclass**:
    ...
    - **m_BloodShardDebuffParticle**: resource_name:"particles/abilities/ghost/ghost_blood_shard_dagger_debuff.vpcf"
- **m_AbilityTooltipDetails**:
  - **m_vecAbilityInfoSections**:
    | m_strLocString | m_vecAbilityPropertiesBlock | m_vecBasicProperties |
    | --- | --- | --- |
    | #ability_blood_shards_desc | [{'m_vecAbilityProperties': [{'m_strImportantProperty': 'HealthToDamage'}]}] | ['NumBloodShards', 'MaxStacks'] |
    |  | [{'m_vecAbilityProperties': [{'m_strImportantProperty': 'VulnerabilityPerStack'}, {'m_strImportantProperty': 'MoveSpeedPenaltyPerStack'}], 'm_strPropertiesTitleLocString': '#ghost_malice_stack_effect_header'}] | ['DebuffDuration', 'SlowDuration'] |
- **m_mapCastEventParticles**:
  - **CAST_COMPLETED**: resource_name:"particles/abilities/ghost/ghost_blood_shard_dagger_self_dmg.vpcf"
...
- **m_eAbilityTargetingShape**: CITADEL_ABILITY_TARGETING_SHAPE_CONE
- **m_nAbilityBehaviors**: CITADEL_ABILITY_BEHAVIOR_DISPLAYS_DAMAGE_IMPACT | CITADEL_ABILITY_BEHAVIOR_CLEAVE_DISABLED | CITADEL_ABILITY_BEHAVIOR_USE_INSTANT_CAST_UNIT_TARGET_UI
- **m_eAbilitySpectatePriority**: CITADELTV_ABILITY_SPECTATE_PRIORITY_HIGH
- **m_flTargetingConeAngle**: 90
- **m_strAbilityImage**: panorama:"file://{images}/hud/abilities/spectre/blood_exchange.psd"
...
- **m_vecAbilityUpgrades**:
  ...
  | [{'m_strPropertyName': 'EnemyMinHealthPct', 'm_strBonus': '-10'}] |
  | [{'m_strPropertyName': 'SelfBuffDuration', 'm_strBonus': '8'}, {'m_strPropertyName': 'TechResist', 'm_strBonus': '40'}, {'m_strPropertyName': 'BonusFireRate', 'm_strBonus': '40'}] |
- **m_strMoviePreviewPath**: file://{resources}/videos/hero_abilities/ghost_blood_exchange.webm
- **m_strCastSound**: soundevent:"Ghost.Blood.Exchange.Cast"
- **m_PreCastModifier**:
  - **subclass**:
    - **_class**: modifier_healthswap_precast
    - **_my_subclass_name**: modifier_healthswap_precast
    - **m_strTargetParticleEffect**: resource_name:"particles/abilities/ghost/ghost_blood_exchange_precast.vpcf"
    - **m_bIsHidden**: True
    - **m_strParticleEffect**: resource_name:"particles/abilities/ghost/ghost_blood_exchange_caster.vpcf"
    - **m_strTargetScreenParticleEffect**: resource_name:"particles/abilities/ghost/ghost_blood_exchange_tgt_screen.vpcf"
    - **m_strTargetEnemyParticleEffect**: resource_name:"particles/abilities/ghost/ghost_blood_exchange_precast_enemy.vpcf"
- **m_SwapModifier**:
  - **subclass**:
    - **_class**: modifier_health_swap_debuff
    - **_my_subclass_name**: modifier_health_swap_debuff
    - **m_sAmbientLoopingSound**: soundevent:"Ghost.BloodExchange.Lp"
    - **m_BloodExchangeParticle**: resource_name:"particles/abilities/ghost/ghost_blood_exchange.vpcf"
- **m_BuffModifier**:
  - **subclass**:
    - **_class**: modifier_base
...
- **m_AbilityTooltipDetails**:
  - **m_vecAbilityInfoSections**:
    | m_strLocString | m_vecAbilityPropertiesBlock | m_vecBasicProperties |
    | --- | --- | --- |
    | #ability_health_swap_desc | [{'m_vecAbilityProperties': [{'m_strImportantProperty': 'EnemyMinHealthPct'}, {'m_strImportantProperty': 'MinHealthTakenPct'}]}] | ['SelfBuffDuration'] |
- **m_SwapParticle**: resource_name:""
- **m_strCastDelaySound**: soundevent:"Ghost.Blood.Exchange.Cast.Delay"
- **m_previewParticle**: resource_name:"particles/abilities/ghost/ghost_blood_exchange_preview.vpcf"
