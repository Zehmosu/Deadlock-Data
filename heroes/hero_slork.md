...
- **_class**: ability_primary_weapon_slork
- **m_mapAbilityProperties**:
  ...
  - **CycleTimeMultiplier**:
    - **m_strValue**: 5.0
    - **m_eProvidedPropertyType**: MODIFIER_VALUE_CYCLE_TIME_PERCENTAGE
  - **DebuffDuration**:
    - **m_strValue**: 2.5
  - **DPS**:
    - **m_strValue**: 16
...
- **m_WeaponInfo**:
  ...
  - **m_szBulletTravelTracerParticle**: resource_name:"particles/abilities/viscous/viscous_sprinkler_proj.vpcf"
  ...
  - **m_mapImpactEffects**:
    - **default**:
      ...
      - **m_strSound**: soundevent:"Slork.Wpn.Impact"
    - **flesh**:
      - **m_strDecal**: 
  ...
  - **m_strReloadSound**: soundevent:"Slork.Wpn.Reload.Clip.Out"
  - **m_strReloadEndSound**: soundevent:"Slork.Wpn.Reload.Clip.In"
  - **m_strZoomInSound**: soundevent:"Slork.Wpn.Zoom.In"
  - **m_strZoomOutSound**: soundevent:"Slork.Wpn.Zoom.Out"
...
- **m_WeaponShapeParticle**: resource_name:"particles/abilities/slork/slork_gun_poison_cloud.vpcf"
- **m_WeaponRangeAssistParticle**: resource_name:"particles/abilities/slork/slork_gun_range_preview.vpcf"
- **m_PoisonSprayerHitSound**: soundevent:"Slork.Wpn.Poison.Hit"
- **m_WeaponLoopStartSound**: soundevent:"Slork.Wpn.Sprayer.Start"
- **m_WeaponLoopSound**: soundevent:"Slork.Wpn.Sprayer.Lp"
- **m_WeaponLoopEndSound**: soundevent:"Slork.Wpn.Sprayer.End"
- **m_HitParticle**: resource_name:"particles/weapon_fx/akimbo/akimbo_gun_dmg.vpcf"
- **m_nNumConePoints**: 3
- **m_DebuffModifier**:
  - **subclass**:
    ...
    - **m_sStartSound**: soundevent:"Slork.Weapon.Victim.Modifier.Start"
    - **m_sAmbientLoopingSound**: soundevent:"Slork.Weapon.Victim.Modifier.Lp"
    - **m_sExpiredSound**: soundevent:"Slork.Weapon.Victim.Modifier.End"
    - **m_strParticleEffect**: resource_name:"particles/abilities/slork/slork_gun_poison_debuff.vpcf"
...
- **m_WeaponInfo**:
  ...
  - **m_szBulletTravelTracerParticle**: resource_name:"particles/abilities/viscous/viscous_sprinkler_proj.vpcf"
  - **m_szMuzzleFlashEffectName**: resource_name:"particles/weapon_fx/default_muzzle_flash.vpcf"
  - **m_strShootSound**: soundevent:"Slork.Wpn.Spear.Fire"
  - **m_strBulletWhizSound**: soundevent:"Slork.Wpn.Spear.Whizby"
  - **m_flBulletWhizDistance**: 150
  - **m_mapImpactEffects**:
    - **default**:
      - **m_strDecal**: Impact.Concrete
  ...
  - **m_strWeaponImpactEffect**: resource_name:"particles/weapon_fx/default_tracer_impact.vpcf"
  - **m_flReloadMoveSpeed**: 10000
  - **m_strLocalPlayerBulletImpactSound**: soundevent:"Slork.Wpn.Spear.Impact.Player"
  - **m_strLocalPlayerBulletImpactHeavySound**: soundevent:"Slork.Wpn.Spear.Impact.Player.Large"
  - **m_strReloadSound**: soundevent:"Slork.Wpn.Reload.Clip.Out"
  - **m_strReloadEndSound**: soundevent:"Slork.Wpn.Reload.Clip.In"
  - **m_strZoomInSound**: soundevent:"Slork.Wpn.Zoom.In"
  - **m_strZoomOutSound**: soundevent:"Slork.Wpn.Zoom.Out"
...
- **m_nAbilityTargetTypes**: CITADEL_UNIT_TARGET_HERO_ENEMY | CITADEL_UNIT_TARGET_PROP_ENEMY | CITADEL_UNIT_TARGET_MINION_ENEMY | CITADEL_UNIT_TARGET_CREEP_ENEMY
- **m_projectileInfo**:
  - **m_flUpSpeed**: 0
  - **m_flSpeed**: 1600
  - **m_flGravityScale**: 2.0
  - **m_bHideImpactParticle**: 1
  - **m_bHideWarningParticle**: 1
  - **m_LoopingSound**: soundevent:"Slork.A1.Scald.Proj.Lp"
  - **m_particle**: resource_name:"particles/abilities/slork/slork_raging_current.vpcf"
  - **m_flVerticalAimBias**: 10.0
- **m_strAbilityImage**: panorama:"file://{images}/hud/abilities/slork/slork_scald.psd"
- **m_strCastAnimGraphParam**: b_ScaldingSpray
- **m_vecAbilityUpgrades**:
  ...
  | [{'m_strPropertyName': 'DPS', 'm_strBonus': '+24'}, {'m_strPropertyName': 'ImpactDamage', 'm_strBonus': '+32'}] |
- **m_DebuffModifier**:
  - **subclass**:
    - **_class**: modifier_slork_riptide
    - **_my_subclass_name**: modifier_slork_riptide
    - **m_sLocalizationName**: modifier_slork_riptide
    - **m_nEnabledStateMask**: 
    - **m_strSmallIconCssClass**: blood_shard
    - **m_eDrawOverheadStatus**: OVERHEAD_DRAW_FOR_CASTER_ONLY
    - **m_strParticleEffect**: resource_name:"particles/abilities/slork/slork_scald_debuff.vpcf"
- **m_strCastSound**: soundevent:"Slork.A1.Scald.Cast"
- **m_strCastDelaySound**: soundevent:"Slork.A1.Scald.PreCast"
...
- **m_mapAbilityProperties**:
  ...
  - **CooldownOnMiss**:
    ...
    - **m_subclassScaleFunction**:
      - **subclass**:
        - **_class**: scale_function_single_stat
        - **_my_subclass_name**: CooldownOnMiss_scale_function
        - **m_eSpecificStatScaleType**: ETechCooldown
  - **BreakRange**:
    - **m_strValue**: 6m
- **m_bitsPostCastEnabledStateMask**: MODIFIER_STATE_BUSY_WITH_ACTION
...
- **m_HUDPanel**:
  ...
  - **m_vecHUDElements**:
    ...
    | --- | --- | --- |
    | CITADEL_ABILITY_HUD_ELEMENT_TYPE_PROGRESS | lassoing | file://{resources}/layout/ability_hud_elements/element_progress_bar.vxml |
- **_multibase**:
  - signature_base
- **m_bStartTrained**: False
- **m_nAbilityPointsCost**: 0
...
- **m_flTargetingConeAngle**: 40
- **m_nAbilityBehaviors**: CITADEL_ABILITY_BEHAVIOR_PREVENT_BOT_USAGE
- **m_nAbilityTargetTypes**: CITADEL_UNIT_TARGET_HERO_ENEMY | CITADEL_UNIT_TARGET_TROOPER_ENEMY | CITADEL_UNIT_TARGET_NEUTRAL | CITADEL_UNIT_TARGET_MINION_ENEMY
- **m_strAbilityImage**: panorama:"file://{images}/hud/abilities/slork/slork_chomp.psd"
- **m_previewParticle**: resource_name:"particles/abilities/slork/slork_chomp_preview.vpcf"
- **m_vecAbilityUpgrades**:
  | m_vecPropertyUpgrades |
  | --- |
  | [{'m_strPropertyName': 'AbilityCooldown', 'm_strBonus': '-11'}] |
  | [{'m_strPropertyName': 'ChompHealPercent', 'm_strBonus': '+150'}] |
  | [{'m_strPropertyName': 'DamagePercentHealth', 'm_strBonus': '6'}] |
- **m_ChompGrapple**:
  - **subclass**:
    - **_my_subclass_name**: modifier_slork_chomp_grapple
    - **_class**: modifier_slork_chomp_grapple
    - **m_sLocalizationName**: modifier_slork_chomp_grapple
    - **m_cameraSequenceCreated**:
      - **m_vecDistanceOperations**:
        ...
        |  |  |  | k_ECameraOp_Maintain |
    - **m_sAmbientLoopingSound**: soundevent:"Slork.A2.Chomp.Captured.Lp"
    - **m_vecSetAndTrackedAnimGraphParams**:
      | m_strName | m_strSetValue | m_strRestoreValue |
      | --- | --- | --- |
      | e_Chomp | chomping | none |
- **m_ChompHobbled**:
  - **subclass**:
    - **_class**: modifier_slork_chomp_hobbled
    - **_my_subclass_name**: modifier_slork_chomp_hobbled
    - **m_sLocalizationName**: modifier_slork_chomp_hobbled
    - **m_eTimeScaleSource**: MODIFIER_TIME_SCALE_USE_CASTER
    - **m_LassoEffect**: resource_name:"particles/abilities/slork/slork_grapple.vpcf"
    - **m_bIsHidden**: True
    - **m_nEnabledStateMask**: MODIFIER_STATE_SLOWED
    - **m_ConsumeSound**: soundevent:"Slork.A2.Chomp.Consumed"
    - **m_vecAutoRegisterModifierValueFromAbilityPropertyName**:
      - HobbledMovementSlow
- **m_LowHealthModifier**:
  - **subclass**:
    - **_class**: modifier_slork_chomp_glow
    - **_my_subclass_name**: modifier_slork_chomp_glow
    - **m_strLocalStatusEffect**: resource_name:"particles/status_fx/status_fx_last_hit.vpcf"
    - **m_bIsHidden**: True
- **m_iUpdateTime**: 1687304900
- **m_strCastSound**: soundevent:"Slork.A2.Chomp.Cast"
- **m_vecDependentAbilities**:
  - ability_chomp_cast_dash

### ESlot_Signature_3

- **_class**: slork_last_breath
- **m_mapAbilityProperties**:
  - **AbilityCooldown**:
    - **m_strValue**: 27
    - **m_strDisableValue**: 0
  ...
  - **BlastRadius**:
    ...
    - **m_subclassScaleFunction**:
      - **subclass**:
        - **_class**: scale_function_single_stat
        - **_my_subclass_name**: BlastRadius_scale_function
        - **m_eSpecificStatScaleType**: ETechRange
  - **DamageAbsorb**:
    - **m_strValue**: 120
    - **m_strCSSClass**: tech_damage
    - **m_subclassScaleFunction**:
      - **subclass**:
        - **_class**: scale_function_tech_damage
        - **_my_subclass_name**: DamageAbsorb_scale_function
        - **m_flStatScale**: 0.6552
  - **BurstDamage**:
    - **m_strValue**: 80
    - **m_strCSSClass**: tech_damage
    - **m_subclassScaleFunction**:
      - **subclass**:
        - **_class**: scale_function_tech_damage
        - **_my_subclass_name**: BurstDamage_scale_function
        - **m_flStatScale**: 0.52416
- **m_bitsPostCastEnabledStateMask**: MODIFIER_STATE_BUSY_WITH_ACTION
- **_editor**:
  - **folder_name**: Hero Slork
...
- **m_strAbilityImage**: panorama:"file://{images}/hud/abilities/slork/slork_current.psd"
- **m_vecAbilityUpgrades**:
  | m_vecPropertyUpgrades |
  | --- |
  | [{'m_strPropertyName': 'AbilityCooldown', 'm_strBonus': '-9'}] |
  | [{'m_strPropertyName': 'DamageAbsorb', 'm_strBonus': '+120'}] |
  | [{'m_strPropertyName': 'BurstDamage', 'm_strBonus': '+120'}] |
- **m_ShieldModifier**:
  - **subclass**:
    - **_class**: modifier_slork_lastbreath
    - **_my_subclass_name**: modifier_slork_lastbreath
    - **m_sLocalizationName**: modifier_slork_lastbreath
    - **m_BulletShieldHitParticle**: resource_name:"particles/upgrades/bullet_shield_impact.vpcf"
    - **m_TechShieldHitParticle**: resource_name:"particles/upgrades/tech_shield_impact.vpcf"
    - **m_BulletShieldImpactModifier**:
      - **subclass**:
        - **_class**: modifier_bullet_shield_impact
        - **_my_subclass_name**: modifier_bullet_shield_impact
        - **m_strParticleEffect**: resource_name:"particles/upgrades/bullet_shield_status.vpcf"
        - **m_bIsHidden**: True
        - **m_ShieldBreakParticle**: resource_name:"particles/upgrades/bullet_shield_impact_break.vpcf"
    - **m_TechShieldImpactModifier**:
      - **subclass**:
        - **_class**: modifier_tech_shield_impact
        - **_my_subclass_name**: modifier_tech_shield_impact
        - **m_strParticleEffect**: resource_name:"particles/upgrades/tech_shield_status.vpcf"
        - **m_ShieldBreakParticle**: resource_name:"particles/upgrades/tech_shield_impact_break.vpcf"
        - **m_bIsHidden**: True
    - **m_flShieldImpactEffectDuration**: 1.5
    - **m_ShieldParticle**: resource_name:"particles/abilities/slork/slork_water_bubble_debuff.vpcf"
    - **m_ExplodeParticle**: resource_name:"particles/abilities/viscous/goo_grenade_explode.vpcf"
    - **m_ExplodeSound**: soundevent:"Viscous.GooBall.Proj.Hit"
    - **m_sStartSound**: soundevent:"Slork.Current.Torrent.Start"
    - **m_sAmbientLoopingSound**: soundevent:"Slork.Current.Torrent.Lp"
    - **m_sExpiredSound**: soundevent:"Slork.Current.Torrent.End"

### ESlot_Signature_4

- **_class**: slork_ability_invis
- **m_mapAbilityProperties**:
  - **AbilityCooldown**:
    - **m_strValue**: 0
    - **m_strDisableValue**: 0
  ...
  - **PreventHealingTime**:
    ...
    - **m_subclassScaleFunction**:
      - **subclass**:
        - **_class**: scale_function_single_stat
        - **_my_subclass_name**: PreventHealingTime_scale_function
        - **m_eSpecificStatScaleType**: ETechDuration
  - **CantHideTime**:
    - **m_strValue**: 5
    - **m_strCSSClass**: duration
  - **AmbushTime**:
    ...
    - **m_subclassScaleFunction**:
      - **subclass**:
        - **_class**: scale_function_single_stat
        - **_my_subclass_name**: AmbushTime_scale_function
        - **m_eSpecificStatScaleType**: ETechDuration
  - **AmbushDamage**:
    - **m_strValue**: 80
    - **m_strCSSClass**: tech_damage
    - **m_subclassScaleFunction**:
      - **subclass**:
        - **_class**: scale_function_tech_damage
        - **_my_subclass_name**: AmbushDamage_scale_function
        - **m_flStatScale**: 0.52416
  - **FullInvisDistance**:
    - **m_strValue**: 50m
  - **InvisRegen**:
    ...
    - **m_subclassScaleFunction**:
      - **subclass**:
        - **_class**: scale_function_single_stat
        - **_my_subclass_name**: InvisRegen_scale_function
...
- **m_nAbilityBehaviors**: CITADEL_ABILITY_BEHAVIOR_DONT_INTERRUPT_SPRINT | CITADEL_ABILITY_BEHAVIOR_CLEAVE_DISABLED | CITADEL_ABILITY_BEHAVIOR_EQUAL_UNIT_TARGET_PRIORITY
- **m_nAbilityTargetTypes**: CITADEL_UNIT_TARGET_ALL_ENEMY
- **m_previewParticle**: resource_name:"particles/abilities/slow_projectile_preview.vpcf"
- **m_strAbilityImage**: panorama:"file://{images}/hud/abilities/slork/slork_invis.psd"
- **m_vecAbilityUpgrades**:
  | m_vecPropertyUpgrades |
  | --- |
  | [{'m_strPropertyName': 'InvisMoveSpeedMod', 'm_strBonus': '+2m'}] |
  | [{'m_strPropertyName': 'InvisFadeToDuration', 'm_strBonus': '-6'}] |
  | [{'m_strPropertyName': 'InvisRegen', 'm_strBonus': '+3'}] |
- **m_AmbushExplosionParticle**: resource_name:"particles/abilities/ballista/ballista_shotgun_blast.vpcf"
- **m_AmbushExplosionSound**: soundevent:"Slork.Ambush.Blast.Fire"
- **m_InvisModifier**:
  - **subclass**:
    - **_class**: modifier_slork_invis
    - **_my_subclass_name**: modifier_slork_invis
    - **m_nAmbientLoopingSoundRecipients**: MODIFIER_SOUND_RECIPIENT_PARENT_IS_LOCAL_PLAYER
    - **m_sAmbientLoopingSound**: soundevent:"Slork.Invis.Modifier.Lp"
    - **m_sStartSound**: soundevent:"Slork.Invis.Modifier.Start"
    - **m_sLocalizationName**: modifier_slork_invis
    ...
    - **m_strInvisRevealedSound**: soundevent:"Slork.Invis.Modifier.Alert"
    - **m_AmbushModifier**:
      - **subclass**:
        - **_class**: modifier_slork_ambush
        - **_my_subclass_name**: modifier_slork_ambush
        - **m_sLocalizationName**: modifier_slork_ambush
        - **m_bPrivateAccess**: False
        - **m_strAmbushEffect**: resource_name:"particles/abilities/slork/ambush_buff.vpcf"
    - **m_VisibleModifier**:
      - **subclass**:
        - **_class**: modifier_slork_visible
        - **_my_subclass_name**: modifier_slork_visible
        - **m_sLocalizationName**: modifier_slork_visible
