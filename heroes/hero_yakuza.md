...
- **m_WeaponInfo**:
  ...
  - **m_mapImpactEffects**:
    - **default**:
      ...
      - **m_strSound**: soundevent:"Yakuza.Wpn.Impact"
    - **flesh**:
      - **m_strDecal**: 
...
- **m_vecDependentAbilities**:
  - yakuza_shakedown
  - yakuza_summon_gangster
  - yakuza_teleport_to_gangster
...
- **_class**: yakuza_shakedown_target
- **m_mapAbilityProperties**:
  - **AbilityCooldown**:
    - **m_strValue**: 25
    - **m_strDisableValue**: 0
...
- **m_strAbilityImage**: panorama:"file://{images}/hud/abilities/theboss/the_boss_shakedown.psd"
- **m_projectileInfo**:
  - **m_flSpeed**: 1600
  - **m_flUpSpeed**: 0
  - **m_bHideWarningParticle**: True
  - **m_flGravityScale**: 1.75
  - **m_particle**: resource_name:"particles/abilities/kelvin/kelvin_ice_grenade_projectile.vpcf"
  - **m_flVerticalAimBias**: 10
  - **m_nBehaviors**: PBF_DetonateOnHitTarget | PBF_DetonateOnHitWorld
  - **m_HitSound**: soundevent:"Yakuza.Shakedown.Explode"
  - **m_LoopingSound**: soundevent:"Yakuza.Shakedown.Proj.Lp"
- **m_strCastAnimGraphParam**: e_GenericThrow
- **m_vecAbilityUpgrades**:
  | m_vecPropertyUpgrades |
  | --- |
  | [{'m_strPropertyName': 'WeaponPowerDebuff', 'm_strBonus': '-30'}] |
  | [{'m_strPropertyName': 'IgnoreChannelSlow', 'm_strBonus': '1'}] |
  | [{'m_strPropertyName': 'ShareDamagePercent', 'm_strBonus': '67'}] |
- **m_PulseModifier**:
  - **subclass**:
    - **_class**: modifier_citadel_shakedown_pulse
    - **_my_subclass_name**: modifier_citadel_shakedown_pulse
    - **m_strFireSound**: soundevent:"Yakuza.Shakedown.Pulse"
    - **m_ShakeParticle**: resource_name:"particles/abilities/engineer/engineer_barrage_explode.vpcf"
    - **m_ChainParticle**: resource_name:"particles/abilities/gigawatt_chain_lightning.vpcf"
- **m_RootModifier**:
  - **subclass**:
    - **_class**: modifier_base
    - **_my_subclass_name**: modifier_citadel_shakedown_target
    - **m_nEnabledStateMask**: MODIFIER_STATE_IMMOBILIZED
    - **m_strParticleEffect**: resource_name:"particles/modifiers/root.vpcf"
    - **m_vecAutoRegisterModifierValueFromAbilityPropertyName**:
      - WeaponPowerDebuff
- **m_strCastSound**: soundevent:"Yakuza.Shakedown.Throw"
...
- **m_mapAbilityProperties**:
  ...
  - **SummonDPS**:
    - **m_strValue**: 60
  - **SummonCasterHealthPct**:
    - **m_strValue**: 0
  - **CloneDamageTakenIncreasePercent**:
    - **m_strValue**: 0
- **m_bitsPostCastEnabledStateMask**: MODIFIER_STATE_BUSY_WITH_ACTION
- **_editor**:
  - **folder_name**: Base
...
- **m_strAbilityImage**: panorama:"file://{images}/hud/abilities/theboss/the_boss_hired_muscle.psd"
- **m_previewParticle**: resource_name:""
- **m_flTargetingConeAngle**: 35.0
- **m_CloneModifier**:
  - **subclass**:
    - **_class**: modifier_hero_clone
    - **_my_subclass_name**: modifier_hero_clone
- **m_vSummonFollowOffset**:
  - 30.0
  - 120.0
  - 0.0
- **m_nAbilityBehaviors**: CITADEL_ABILITY_BEHAVIOR_ALLOW_SELF_CAST
- **m_vecAbilityUpgrades**:
  | m_vecPropertyUpgrades |
  | --- |
  | [{'m_strPropertyName': 'SummonCasterHealthPct', 'm_strBonus': '20'}] |
  | [{'m_strPropertyName': 'SummonDPS', 'm_strBonus': '45'}] |
  | [{'m_strPropertyName': 'SummonCount', 'm_strBonus': '1'}] |

### ESlot_Signature_3

- **_class**: yakuza_protection_racket
- **m_mapAbilityProperties**:
  - **AbilityCooldown**:
    - **m_strValue**: 30
    - **m_strDisableValue**: 0
  ...
  - **BulletShieldHealth**:
    ...
    - **m_eProvidedPropertyType**: MODIFIER_VALUE_BULLET_SHIELD_HEALTH
  - **BonusCritDamagePercent**:
    - **m_strValue**: 20
    - **m_strCSSClass**: bullet_damage
    - **m_eProvidedPropertyType**: MODIFIER_VALUE_BONUS_CRIT_DAMAGE_PERCENT
    - **m_UsageFlags**: APUsageFlag_ModifierConditional
...
- **m_eAbilityTargetingShape**: CITADEL_ABILITY_TARGETING_SHAPE_CONE
- **m_eAbilityActivation**: CITADEL_ABILITY_ACTIVATION_PRESS
- **m_nAbilityBehaviors**: CITADEL_ABILITY_BEHAVIOR_DISPLAYS_DAMAGE_IMPACT|CITADEL_ABILITY_BEHAVIOR_PROJECTILE_PASS_THROUGH_WORLD|CITADEL_ABILITY_BEHAVIOR_EQUAL_UNIT_TARGET_PRIORITY|CITADEL_ABILITY_BEHAVIOR_ALLOW_SELF_CAST
- **m_nAbilityTargetTypes**: CITADEL_UNIT_TARGET_HERO_FRIENDLY
- **m_eAbilitySpectatePriority**: CITADELTV_ABILITY_SPECTATE_PRIORITY_MEDIUM
- **m_flTargetingConeAngle**: 35.0
- **m_strAbilityImage**: panorama:"file://{images}/hud/abilities/theboss/the_boss_protection_racket.psd"
- **m_strCastAnimGraphParam**: e_GenericCast
- **m_vecAbilityUpgrades**:
  | m_vecPropertyUpgrades |
  | --- |
  | [{'m_strPropertyName': 'WeaponRecoilReduction', 'm_strBonus': '60'}, {'m_strPropertyName': 'MoveWhileShootingSpeedPenaltyReductionPercent', 'm_strBonus': '60'}] |
  | [{'m_strPropertyName': 'BonusCritDamagePercent', 'm_strBonus': '40'}] |
  | [{'m_strPropertyName': 'BulletShieldHealth', 'm_strBonus': '360'}] |
- **m_strCastSound**: soundevent:"Yakuza.Protection.Racket.Cast"
- **m_ArmorModifier**:
  - **subclass**:
    - **_class**: modifier_consumed_protection_racket
    - **_my_subclass_name**: modifier_consumed_protection_racket
    - **m_sAmbientLoopingSound**: soundevent:"Yakuza.Protection.Racket.lp"
    - **m_strShieldBreakSound**: soundevent:"Yakuza.Protection.Racket.break"
    - **m_strParticleEffect**: resource_name:"particles/abilities/ballista/ballista_teamwork_buff.vpcf"
    - **m_vecAutoRegisterModifierValueFromAbilityPropertyName**:
      - BonusCritDamagePercent
      - WeaponRecoilReduction
      - MoveWhileShootingSpeedPenaltyReductionPercent
- **m_CastOtherParticle**: resource_name:"particles/abilities/ballista/ballista_teamwork_cast.vpcf"

### ESlot_Signature_4

- **_class**: yakuza_setting_sun
- **m_mapAbilityProperties**:
  - **AbilityCooldown**:
    - **m_strValue**: 70
    - **m_strDisableValue**: 0
  ...
  - **OuterDamage**:
    ...
    - **m_subclassScaleFunction**:
      - **subclass**:
        - **_class**: scale_function_tech_damage
        - **_my_subclass_name**: OuterDamage_scale_function
        - **m_flStatScale**: 0.6552
  - **BossDamagePercent**:
    - **m_strValue**: 25
  - **CenterRadius**:
  ...
  - **Range**:
    ...
    - **m_subclassScaleFunction**:
      - **subclass**:
        - **_class**: scale_function_single_stat
        - **_my_subclass_name**: Range_scale_function
        - **m_eSpecificStatScaleType**: ETechRadius
  - **SecondHit**:
    - **m_strValue**: 0
  - **StunDuration**:
...
- **m_eAbilityTargetingLocation**: CITADEL_ABILITY_TARGETING_LOCATION_NONE
- **m_eAbilityActivation**: CITADEL_ABILITY_ACTIVATION_PRESS
- **m_strAbilityImage**: panorama:"file://{images}/hud/abilities/theboss/the_boss_setting_sun.psd"
- **m_nAbilityTargetTypes**: CITADEL_UNIT_TARGET_ALL_ENEMY
- **m_flSSCameraPreviewOffset**: 100
- **m_flSSCameraPreviewSpeed**: 0.3
- **m_flSSCameraPreviewDistance**: 300
- **m_strCastAnimGraphParam**: b_GenericThrow
- **m_vecAbilityUpgrades**:
  | m_vecPropertyUpgrades |
  | --- |
  | [{'m_strPropertyName': 'AbilityCooldown', 'm_strBonus': '-20'}] |
  | [{'m_strPropertyName': 'Range', 'm_strBonus': '175m'}] |
  | [{'m_strPropertyName': 'CenterDamage', 'm_strBonus': '200'}] |
- **m_BeamTargetParticle**: resource_name:"particles/ui/ui_range_finder_xray.vpcf"
...
- **m_SettingSunThinkerModifier**:
  - **subclass**:
    - **_class**: modifier_setting_sun_thinker
    - **_my_subclass_name**: modifier_setting_sun_thinker
    - **m_ExplodeParticle**: resource_name:"particles/abilities/ghost/ghost_blood_bomb_explode.vpcf"
    - **m_LingerParticle**: resource_name:"particles/abilities/yakuza/yakuza_setting_sun_cast.vpcf"
    - **m_TargetParticle**: resource_name:"particles/abilities/yakuza/yakuza_setting_sun_preview.vpcf"
    - **m_LayerParticle**: resource_name:"particles/abilities/yakuza/yakuza_setting_sun_cast_streaks.vpcf"
    - **m_strTargetingCompletedSound**: soundevent:"Yakuza.Setting.Sun.Cast"
    - **m_strExplodeSound**: soundevent:"Yakuza.Setting.Sun.Impact"
