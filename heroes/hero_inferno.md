...
- **m_eAbilityTargetingLocation**: CITADEL_ABILITY_TARGETING_LOCATION_NONE
- **m_eAbilityActivation**: CITADEL_ABILITY_ACTIVATION_INSTANT_CAST
- **m_nAbilityBehaviors**: CITADEL_ABILITY_BEHAVIOR_PROJECTILE | CITADEL_ABILITY_BEHAVIOR_DISPLAYS_DAMAGE_IMPACT | CITADEL_ABILITY_BEHAVIOR_SHOW_CAST_RANGE_AS_SAT_SPHERE_WHILE_CASTING
...
- **m_vecAbilityUpgrades**:
  ...
  | [{'m_strPropertyName': 'LifestealPercentHero', 'm_strBonus': '20'}] |
  | [{'m_strPropertyName': 'DamageAmplification', 'm_strBonus': '10'}, {'m_strPropertyName': 'HealAmpReceivePenaltyPercent', 'm_strBonus': '-40'}, {'m_strPropertyName': 'HealAmpRegenPenaltyPercent', 'm_strBonus': '-40'}] |
...
- **m_vecAbilityUpgrades**:
  | m_vecPropertyUpgrades |
  | --- |
  | [{'m_strPropertyName': 'FireRateSlow', 'm_strBonus': '30'}, {'m_strPropertyName': 'FlameDashDebuffDuration', 'm_strBonus': '7'}] |
...
- **m_AbilityTooltipDetails**:
  - **m_vecAbilityInfoSections**:
    | m_strLocString | m_vecAbilityPropertiesBlock | m_vecBasicProperties |
    | --- | --- | --- |
    | #ability_flame_dash_desc | [{'m_vecAbilityProperties': [{'m_strImportantProperty': 'SpeedBurstSpeed'}, {'m_strImportantProperty': 'FlameAuraDPS'}]}] | ['DashTime', 'DashSpeed', 'FlameDashDebuffDuration', 'GroundFlameDuration'] |
