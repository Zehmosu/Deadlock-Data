...
- **m_vecAbilityUpgrades**:
  ...
  | [{'m_strPropertyName': 'DebuffDuration', 'm_strBonus': '2'}] |
...
- **m_AbilityTooltipDetails**:
  - **m_vecAbilityInfoSections**:
    ...
    | --- | --- | --- |
    | #citadel_ability_shiv_dagger_desc | [{'m_vecAbilityProperties': [{'m_strImportantProperty': 'ImpactDamage'}, {'m_strImportantProperty': 'BleedDPSPerStack'}, {'m_strImportantProperty': 'DebuffDuration'}]}] | [] |
...
- **m_vecAbilityUpgrades**:
  ...
  | [{'m_strPropertyName': 'ImpactDamage', 'm_strBonus': '100'}] |
  | [{'m_strPropertyName': 'CooldownReductionOnHit', 'm_strBonus': '2'}] |
