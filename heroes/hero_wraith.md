...
- **m_WeaponInfo**:
  ...
  - **m_szBulletTravelTracerParticle**: resource_name:"particles/weapon_fx/wraith/wraith_tracer.vpcf"
  - **m_szMuzzleFlashEffectName**: resource_name:"particles/weapon_fx/wraith/wraith_muzzle_flash.vpcf"
  - **m_strShootSound**: soundevent:"Wraith.Wpn.Fire"
  - **m_strBulletWhizSound**: soundevent:"Wraith.Wpn.Whizby"
  ...
  - **m_strReloadSound**: soundevent:"Wraith.Wpn.Reload.Clip.Out"
  - **m_strReloadEndSound**: soundevent:"Wraith.Wpn.Reload.Clip.In"
  - **m_strZoomInSound**: soundevent:"Wraith.Wpn.Zoom.In"
  - **m_strZoomOutSound**: soundevent:"Wraith.Wpn.Zoom.Out"
  - **m_bBulletShouldUseVerlet**: True
  - **m_flSpreadPerShot**: 0.0
  - **m_flRecoilRecoveryDelayFactor**: 0.05
  - **m_flSpreadDecay**: 2.5
  - **m_nRecoilSeed**: 32152
  ...
  - **m_StandingShootSpreadPenalty**:
    - 0.0
    - 0.2
  - **m_strBulletImpactSound**: soundevent:"Wraith.Wpn.Impact"
  - **m_flBulletDamage**: 5.5
  - **m_szSelfBulletTravelTracerParticle**: resource_name:"particles/weapon_fx/wraith/wraith_tracer_player.vpcf"
- **_multibase**:
  - hero_weapon_base
...
- **_class**: citadel_ability_card_toss
- **m_mapAbilityProperties**:
  - **AbilityCooldown**:
    - **m_strValue**: 0.5
    - **m_strDisableValue**: 0
...
- **m_HUDPanel**:
  ...
  - **m_vecHUDElements**:
    | m_eType | m_strContext |
    | --- | --- |
    | CITADEL_ABILITY_HUD_ELEMENT_TYPE_UNIT_TARGET | unit_target |
- **_multibase**:
  - signature_base
...
- **m_eAbilityActivation**: CITADEL_ABILITY_ACTIVATION_INSTANT_CAST
- **m_strAbilityImage**: panorama:"file://{images}/hud/abilities/wraith_card_trick.psd"
- **m_nAbilityBehaviors**: CITADEL_ABILITY_BEHAVIOR_PROJECTILE | CITADEL_ABILITY_BEHAVIOR_NO_TARGET | CITADEL_ABILITY_BEHAVIOR_DISPLAYS_DAMAGE_IMPACT | CITADEL_ABILITY_BEHAVIOR_USE_INSTANT_CAST_UNIT_TARGET_UI
- **m_nAbilityTargetTypes**: CITADEL_UNIT_TARGET_ALL_ENEMY
- **m_projectileInfo**:
  - **m_flSpeed**: 1200.0
  - **m_flUpSpeed**: 0
  - **m_particle**: resource_name:"particles/abilities/wraith/wraith_royal_flush_projectile.vpcf"
  - **m_warningParticle**: resource_name:""
  - **m_nBehaviors**: PBF_DetonateOnHitTarget | PBF_DetonateOnHitWorld
  - **m_DetonateSound**: soundevent:"Wraith.PsychicDagger.Impact"
  - **m_LoopingSound**: soundevent:"Wraith.PsychicDagger.Proj_Lp"
  - **m_flTrackingDampingCoefficient**: 0.7
  - **m_bHideWarningParticle**: True
  - **m_flTriggerRadius**: 15.0
- **m_strCastAnimGraphParam**: e_CardToss
- **m_strSecondaryStatName**: ability_blood_bomb_bloodspill
- **m_strCastSound**: soundevent:"Wraith.PsychicDagger.Cast"
- **m_strMoviePreviewPath**: file://{resources}/videos/hero_abilities/wraith_card_trick.webm
- **m_ExplodeParticle**: resource_name:"particles/abilities/wraith/wraith_royal_flush_projectile_impact.vpcf"
- **m_flTargetingConeAngle**: 4.0
- **m_SummonedCard**: resource_name:"particles/abilities/wraith/wraith_psychic_card_spawn.vpcf"
- **m_flSummonedCardVerticalOffset**: 120.0
- **m_flSummonedCardSideOffsetStep**: 10.0
- **m_strCardTossSound**: soundevent:"Wraith.PsychicDagger.Fire"
- **m_AbilityTooltipDetails**:
  - **m_vecAbilityInfoSections**:
    | m_strLocString | m_vecAbilityPropertiesBlock |
    | --- | --- |
    | #citadel_ability_card_toss_desc | [{'m_vecAbilityProperties': [{'m_strImportantProperty': 'Damage'}, {'m_strImportantProperty': 'AbilityCharges'}]}] |
- **m_vecAbilityUpgrades**:
  ...
  | [{'m_strPropertyName': 'CardResourceGenPctScale', 'm_strBonus': '50'}] |
- **m_flSummonedCardStartSideOffset**: -18.0
- **m_flSummonedCardForwardOffset**: -20.0
- **m_strCardSummonSound**: soundevent:"Wraith.PsychicDagger.Start"
- **m_bIncludeExtra2DCone**: False
- **m_strChannelLoopSound**: soundevent:"Wraith.PsychicDagger.Proj_Lp"
...
- **m_nAbilityBehaviors**: CITADEL_ABILITY_BEHAVIOR_DEPLOY_OBJECT | CITADEL_ABILITY_BEHAVIOR_PREVENT_BOT_USAGE | CITADEL_ABILITY_BEHAVIOR_MOVEMENT
- **m_deploymentInfo**:
  - **m_bCheckPlayerFit**: True
  - **m_bPointTrace**: True
  - **m_previewParticle**: resource_name:"particles/abilities/wraith/wraith_project_mind_deploy.vpcf"
- **m_strAbilityImage**: panorama:"file://{images}/hud/abilities/wraith_teleport.psd"
- **m_vecAbilityUpgrades**:
  | m_vecPropertyUpgrades |
  | --- |
  | [{'m_strPropertyName': 'AbilityCastRange', 'm_strBonus': '15m'}] |
  | [{'m_strPropertyName': 'BulletShieldOnLand', 'm_strBonus': '300'}, {'m_strPropertyName': 'BulletShieldDuration', 'm_strBonus': '8'}, {'m_strPropertyName': 'BulletShieldOnLand', 'm_eUpgradeType': 'EAddToScale', 'm_eScaleStatFilter': 'ETechPower', 'm_strBonus': 2.6208}] |
...
- **m_ProjectMindModifier**:
  - **subclass**:
    ...
    - **m_bIsHidden**: True
    - **m_TeleportStartParticle**: resource_name:"particles/abilities/wraith/wraith_project_mind_start.vpcf"
    - **m_TeleportEndParticle**: resource_name:"particles/abilities/wraith/wraith_project_mind_end.vpcf"
    - **m_TeleportTrailParticle**: resource_name:"particles/abilities/wraith/wraith_project_mind_trail.vpcf"
    - **m_TeleportModelParticle**: resource_name:"particles/abilities/wraith/wraith_project_mind_trail_model.vpcf"
    - **m_sExpiredSound**: soundevent:"Wraith.ProjectMind.Arrive"
    - **m_ShieldModifier**:
      - **subclass**:
    ...
    - **m_sStartSound**: soundevent:"Wraith.ProjectMind.Cast"
...
- **m_AbilityTooltipDetails**:
  - **m_vecAbilityInfoSections**:
    | m_strLocString |
    | --- |
    | #citadel_ability_projectmind_desc |
    |  |
- **m_strSelectedSound**: soundevent:"Wraith.ProjectMind.Select"
- **m_strUnselectedSound**: soundevent:"Wraith.ProjectMind.Deselect"
...
- **m_strAbilityImage**: panorama:"file://{images}/hud/abilities/wraith_aura.psd"
- **m_vecAbilityUpgrades**:
  | m_vecPropertyUpgrades |
  | --- |
  | [{'m_strPropertyName': 'AbilityCooldown', 'm_strBonus': '-15'}] |
  | [{'m_strPropertyName': 'MagicDamagePerBullet', 'm_strBonus': '5'}] |
  | [{'m_strPropertyName': 'BulletLifestealPercent', 'm_strBonus': '35'}] |
- **m_strCastSound**: soundevent:"Wraith.RapidFire.Cast"
...
- **m_AbilityTooltipDetails**:
  - **m_vecAbilityInfoSections**:
    | m_strLocString | m_vecAbilityPropertiesBlock |
    | --- | --- |
    | #citadel_ability_wraith_rapidfire_desc | [{'m_vecAbilityProperties': [{'m_strImportantProperty': 'BonusFireRate'}, {'m_strImportantProperty': 'BulletLifestealPercent', 'm_bRequiresAbilityUpgrade': True}, {'m_strImportantProperty': 'MagicDamagePerBullet'}]}] |
- **m_CastParticle**: resource_name:"particles/abilities/wraith/wraith_rapid_fire_cast.vpcf"
- **m_TargetBuffSound**: soundevent:""
- **m_RapidFireModifier**:
  - **subclass**:
    - **_my_subclass_name**: modifier_rapidfire
    - **_class**: modifier_rapidfire
    - **m_RapidFireParticle**: resource_name:"particles/abilities/wraith/wraith_rapid_fire_buff.vpcf"
    - **m_bIsHidden**: True
...
- **_class**: citadel_ability_psychic_lift
- **m_mapAbilityProperties**:
  - **AbilityCooldown**:
    - **m_strValue**: 90
    - **m_strDisableValue**: 0
...
- **m_eAbilityTargetingShape**: CITADEL_ABILITY_TARGETING_SHAPE_CONE
- **m_eAbilityActivation**: CITADEL_ABILITY_ACTIVATION_PRESS
- **m_nAbilityBehaviors**: CITADEL_ABILITY_BEHAVIOR_PROJECTILE_PASS_THROUGH_WORLD
...
- **m_projectileInfo**:
  ...
  - **m_particle**: resource_name:"particles/abilities/wraith/wraith_psychic_lift_projectile.vpcf"
  - **m_flSpeed**: 650
  - **m_LoopingSound**: soundevent:"Wraith.PsychicLift.Proj.Lp"
  - **m_HitSound**: soundevent:"Wraith.PsychicLift.Impact"
- **m_previewParticle**: resource_name:"particles/abilities/wraith/wraith_psychic_lift_projectile_preview.vpcf"
- **m_strAbilityImage**: panorama:"file://{images}/hud/abilities/wraith_lift.psd"
...
- **m_vecAbilityUpgrades**:
  ...
  | [{'m_strPropertyName': 'AbilityUnitTargetLimit', 'm_strBonus': '5'}] |
- **m_TargetCastSound**: soundevent:"Wraith.PsychicLift.Victim.Alert"
- **m_strMoviePreviewPath**: file://{resources}/videos/hero_abilities/wraith_psychic_lift.webm
- **m_TargetParticle**: resource_name:"particles/abilities/wraith/wraith_psychic_lift_cast.vpcf"
- **m_LiftModifier**:
  - **subclass**:
    - **_class**: modifier_citadel_psychiclift
    ...
    - **m_cameraSequenceCreated**:
      - **m_vecDistanceOperations**:
        ...
        |  |  |  | k_ECameraOp_Maintain |
    - **m_LiftParticle**: resource_name:"particles/abilities/wraith/wraith_psychic_lift.vpcf"
    - **m_nEnabledStateMask**: MODIFIER_STATE_STUNNED
    - **m_bIsHidden**: True
    - **m_strHudMessageText**: #modifier_citadel_psychiclift
    - **m_EmpParticle**: resource_name:""
    - **m_EmpPlayerParticle**: resource_name:""
- **m_AbilityTooltipDetails**:
  - **m_vecAbilityInfoSections**:
    | m_strLocString | m_vecAbilityPropertiesBlock |
    | --- | --- |
    | #citadel_ability_psychic_lift_desc | [{'m_vecAbilityProperties': [{'m_strImportantProperty': 'Damage'}]}] |
- **m_strSelectedLoopSound**: soundevent:"Wraith.PsychicLift.Select_Lp"
- **m_strSelectedSound**: soundevent:"Wraith.PsychicLift.Select"
- **m_strCastDelaySound**: soundevent:"Wraith.PsychicLift.Cast_Delay"
- **m_strCastSound**: soundevent:"Wraith.PsychicLift.Cast"
