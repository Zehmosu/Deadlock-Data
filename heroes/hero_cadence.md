...
- **m_strAbilityImage**: panorama:"file://{images}/hud/abilities/cadence/cadence_ability_1.psd"
- **m_AnthemAOEModifier**:
  - **subclass**:
    ...
    - **m_modifierProvidedByAura**:
      - **subclass**:
        ...
        - **m_strParticleEffect**: resource_name:"particles/abilities/cadence/cadence_anthem_buff.vpcf"
    - **m_sLocalizationName**: modifier_cadence_anthem_aoe
    - **m_strParticleEffect**: resource_name:""
    - **m_sAmbientLoopingSound**: soundevent:"Cadence.Anthem.Lp"
    - **m_AuraParticle**: resource_name:"particles/abilities/cadence/cadence_anthem.vpcf"
    - **m_sExpiredSound**: soundevent:"Cadence.SongEnd"
- **m_vecAbilityUpgrades**:
  | m_vecPropertyUpgrades |
  | --- |
  | [{'m_strPropertyName': 'ExtraLargeClip', 'm_strBonus': '75'}] |
  | [{'m_strPropertyName': 'Radius', 'm_strBonus': '4m'}] |
  | [{'m_strPropertyName': 'PeakFireRateBonus', 'm_strBonus': '100'}] |

### ESlot_Signature_2

- **_class**: cadence_ability_silencecontraptions
- **m_mapAbilityProperties**:
  - **AbilityCooldown**:
    - **m_strValue**: 40
    - **m_strDisableValue**: 0
...
- **m_nAbilityBehaviors**: CITADEL_ABILITY_BEHAVIOR_DISPLAYS_DAMAGE_IMPACT
- **m_nAbilityTargetTypes**: CITADEL_UNIT_TARGET_ALL
- **m_strAbilityImage**: panorama:"file://{images}/hud/abilities/cadence/cadence_ability_2.psd"
- **m_AbilityToTrigger**: citadel_ability_melee_cadence
...
- **m_MovementSpeedCurve**:
  - **m_spline**:
    | x | y | m_flSlopeIncoming | m_flSlopeOutgoing |
    | --- | --- | --- | --- |
    | 0.0 | 0.477455 | 0.259289 | 0.259289 |
    | 0.354116 | 0.569273 | 1.13132 | 1.13132 |
    | 0.46189 | 1.0 | 0.66688 | 0.66688 |
    | 1.0 | 1.0 | 0.0 | 0.0 |
  - **m_tangents**:
    | m_nIncomingTangent | m_nOutgoingTangent |
    | --- | --- |
...
- **m_mapCastEventParticles**:
  - **CAST_COMPLETED**: resource_name:"particles/abilities/shiv/shiv_dash_start.vpcf"
- **m_flDashSpeed**: 2400.0
- **m_flDashCastTriggerRadius**: 75.0
- **m_cameraSequenceCastStart**:
  - **m_strToken**: 
  - **m_bIsEmpty**: False
  - **m_vecDistanceOperations**:
...
- **m_cameraSequenceCastComplete**:
  - **m_vecTargetPosOperations**:
    | m_flLagTime | m_flLagSpringStrength | m_eCameraOperation |
    | --- | --- | --- |
    | 0.1 | 10.0 | k_ECameraOp_Lag |
- **m_SilenceContraptionsModifier**:
  - **subclass**:
    - **_class**: modifier_cadence_silence_contraptions
    - **_my_subclass_name**: modifier_cadence_silence_contraptions
    - **m_sLocalizationName**: modifier_cadence_silence_contraptions
    - **m_sAmbientLoopingSound**: soundevent:"Cadence.SilenceContraptions.Lp"
    - **m_strParticleEffect**: resource_name:"particles/abilities/cadence/cadence_silencecontraptions_debuff.vpcf"
    - **m_sExpiredSound**: soundevent:"Cadence.SongEnd"
    - **m_DebuffModifier**:
      - **subclass**:
        - **_class**: modifier_cadence_silence_contraptions_debuff
        - **_my_subclass_name**: modifier_cadence_silence_contraptions_debuff
        - **m_sLocalizationName**: modifier_cadence_silence_contraptions_debuff
        - **m_strParticleEffect**: resource_name:"particles/abilities/cadence/cadence_silencecontraptions_debuff.vpcf"
        - **m_vecAutoRegisterModifierValueFromAbilityPropertyName**:
          - SlowPercent
    - **m_vecAutoRegisterModifierValueFromAbilityPropertyName**:
...
- **m_vecAbilityUpgrades**:
  ...
  | [{'m_strPropertyName': 'DashDistance', 'm_strBonus': '4m'}] |
  | [{'m_strPropertyName': 'DebuffDuration', 'm_strBonus': '1.5'}] |

### ESlot_Signature_3

- **_class**: cadence_ability_lullaby
- **m_mapAbilityProperties**:
  - **AbilityCooldown**:
    - **m_strValue**: 45
    - **m_strDisableValue**: 0
  ...
  - **MinimumSleepTime**:
    ...
    - **m_subclassScaleFunction**:
      - **subclass**:
        - **_class**: scale_function_single_stat
        - **_my_subclass_name**: MinimumSleepTime_scale_function
        - **m_eSpecificStatScaleType**: ETechDuration
  - **SleepWakeUpDelay**:
    - **m_strValue**: .25
    - **m_bIsHidden**: True
...
- **m_nAbilityBehaviors**: CITADEL_ABILITY_BEHAVIOR_DISPLAYS_DAMAGE_IMPACT
- **m_nAbilityTargetTypes**: CITADEL_UNIT_TARGET_ALL
- **m_strAbilityImage**: panorama:"file://{images}/hud/abilities/cadence/cadence_ability_3.psd"
- **m_SleepAOEModifier**:
  - **subclass**:
    - **_class**: modifier_cadence_sleep_aoe
    - **_my_subclass_name**: modifier_cadence_sleep_aoe
    - **m_iAuraSearchType**: CITADEL_UNIT_TARGET_HERO_ENEMY | CITADEL_UNIT_TARGET_TROOPER_ENEMY | CITADEL_UNIT_TARGET_MINION_ENEMY
    - **m_modifierProvidedByAura**:
      - **subclass**:
        - **_class**: modifier_cadence_sleeping
        - **_my_subclass_name**: modifier_cadence_sleeping
        - **m_sLocalizationName**: modifier_cadence_sleeping
        - **m_strParticleEffect**: resource_name:"particles/abilities/haze/haze_sleep_dagger_debuff.vpcf"
    - **m_sLocalizationName**: modifier_cadence_sleep_aoe
    - **m_strParticleEffect**: resource_name:""
    - **m_sAmbientLoopingSound**: soundevent:"Cadence.Lullaby.Lp"
    - **m_AuraParticle**: resource_name:"particles/abilities/cadence/cadence_lullaby.vpcf"
    - **m_sExpiredSound**: soundevent:"Cadence.SongEnd"
    - **m_vecAutoRegisterModifierValueFromAbilityPropertyName**:
      - ExternalBonusHealthRegen
- **m_vecAbilityUpgrades**:
  | m_vecPropertyUpgrades |
  | --- |
  | [{'m_strPropertyName': 'ExternalBonusHealthRegen', 'm_strBonus': '15'}] |
  | [{'m_strPropertyName': 'Radius', 'm_strBonus': '2m'}] |
  | [{'m_strPropertyName': 'LingerDuration', 'm_strBonus': '.75'}] |
...
- **m_strAbilityImage**: panorama:"file://{images}/hud/abilities/cadence/cadence_ability_4.psd"
  ...
  - **subclass**:
    ...
    - **m_modifierProvidedByAura**:
      - **subclass**:
        ...
        - **m_strParticleEffect**: resource_name:"particles/abilities/cadence/cadence/cadence_crescendo_debuff.vpcf"
        ...
        - **m_sExpiredSound**: soundevent:"Cadence.Crescendo.Debuff.End"
        - **m_PostAOEModifier**:
          - **subclass**:
    ...
    - **m_AuraParticle**: resource_name:"particles/abilities/cadence/cadence_crescendo.vpcf"
    - **m_sAmbientLoopingSound**: soundevent:"Cadence.Crescendo.Lp"
    - **m_sExpiredSound**: soundevent:"Cadence.SongEnd"
- **m_vecAbilityUpgrades**:
  | m_vecPropertyUpgrades |
  | --- |
  | [{'m_strPropertyName': 'BulletResist', 'm_strBonus': '-10'}] |
  | [{'m_strPropertyName': 'DebuffDuration', 'm_strBonus': '4'}] |
