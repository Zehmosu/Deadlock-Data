...
- **m_WeaponInfo**:
  ...
  - **m_strShootSound**: soundevent:"Forge.Wpn.Fire"
  - **m_strBulletWhizSound**: soundevent:"Forge.Wpn.BulletWhizby"
  ...
  - **m_flShootSpreadPenaltyPerShot**: 0.45
  ...
  - **m_strZoomInSound**: soundevent:"Engineer.ZoomIn"
  - **m_strZoomOutSound**: soundevent:"Engineer.ZoomOut"
  - **m_bBulletShouldUseVerlet**: True
  - **m_bSpinsUp**: 1
  - **m_flMaxSpinCycleTime**: 0.08
  - **m_flSpinIncreaseRate**: 0.5
  - **m_flSpinDecayRate**: 0.65
  - **m_flSpreadPerShot**: 0.15
  ...
  - **m_StandingShootSpreadPenalty**:
    - 0.0
    - 0.5
  - **m_strSpinUpSound**: soundevent:"Forge.Wpn.SpinUp.Start"
  - **m_strSpinUpLoopSound**: soundevent:"Forge.Wpn.Spin.Lp"
  - **m_strSpinDownSound**: soundevent:"Forge.Wpn.Spin.Down"
  - **m_strBulletImpactSound**: soundevent:"Forge.Wpn.Impact"
  - **m_flBulletDamage**: 7.15
- **_multibase**:
  - hero_weapon_base
...
- **_class**: citadel_ability_shieldedsentry
- **m_mapAbilityProperties**:
  - **AbilityCooldown**:
    - **m_strValue**: 28
    - **m_strDisableValue**: 0
  ...
  - **TurretAttackRange**:
    ...
    - **m_subclassScaleFunction**:
      - **subclass**:
        - **_class**: scale_function_single_stat
        - **_my_subclass_name**: TurretAttackRange_scale_function
        - **m_eSpecificStatScaleType**: ETechRange
  - **TurretAttackFalloffStart**:
    ...
    - **m_subclassScaleFunction**:
      - **subclass**:
        - **_class**: scale_function_single_stat
        - **_my_subclass_name**: TurretAttackFalloffStart_scale_function
        - **m_eSpecificStatScaleType**: ETechRange
  - **TurretAttackFalloffEnd**:
    ...
    - **m_subclassScaleFunction**:
      - **subclass**:
        - **_class**: scale_function_single_stat
        - **_my_subclass_name**: TurretAttackFalloffEnd_scale_function
        - **m_eSpecificStatScaleType**: ETechRange
  - **TurretAttackDelay**:
    - **m_strValue**: .35
  - **TurretDPS**:
    ...
    - **m_subclassScaleFunction**:
      - **subclass**:
        ...
        - **_my_subclass_name**: TurretDPS_scale_function
  ...
  - **TurretLifetime**:
    ...
    - **m_subclassScaleFunction**:
      - **subclass**:
        - **_class**: scale_function_single_stat
        - **_my_subclass_name**: TurretLifetime_scale_function
        - **m_eSpecificStatScaleType**: ETechDuration
...
- **m_WeaponInfo**:
  ...
  - **m_flRecoilSpeed**: 1
  - **m_flZoomFOV**: 35.0
  - **m_flDamageFalloffStartRange**: 787.402
  - **m_flDamageFalloffEndRange**: 1377.95
  - **m_flRange**: 2500
  - **m_flBulletLifetime**: 2
  - **m_flDamageFalloffStartScale**: 1.0
  - **m_flDamageFalloffEndScale**: 0.65
  - **m_flDamageFalloffBias**: 0.5
  - **m_iBullets**: 1
  - **m_flCycleTime**: 0.5
  ...
  - **m_flBulletReflectAmount**: 1
  - **m_flBulletInheritShooterVelocityScale**: 0
  - **m_szBulletTravelTracerParticle**: resource_name:"particles/weapon_fx/engineer/engineer_sentry_tracer.vpcf"
  - **m_szMuzzleFlashEffectName**: resource_name:"particles/weapon_fx/engineer/engineer_sentry_muzzle_flash.vpcf"
  ...
  - **m_flRecoilShotIndexRecoveryTimeFactor**: 0.25
  - **m_bCanZoom**: True
  - **m_strWeaponImpactEffect**: resource_name:"particles/weapon_fx/engineer/engineer_sentry_tracer_impact.vpcf"
  - **m_flReloadMoveSpeed**: 10000
  ...
  - **m_flBulletDamage**: 25.0
  - **m_eAttachmentSourceType**: EAttachmentSource_Custom
  - **m_strCustomAttachmentSource**: muzzle_fx
...
- **m_nAbilityBehaviors**: CITADEL_ABILITY_BEHAVIOR_DEPLOY_OBJECT | CITADEL_ABILITY_BEHAVIOR_PREVENT_TRAINING_BOT_USAGE | CITADEL_ABILITY_BEHAVIOR_DISPLAYS_DAMAGE_IMPACT
- **m_nAbilityTargetTypes**: CITADEL_UNIT_TARGET_ALL_ENEMY
- **m_strAbilityImage**: panorama:"file://{images}/hud/abilities/engineer_turret.psd"
- **m_strMoviePreviewPath**: file://{resources}/videos/hero_abilities/ability_forge_turret.webm
- **m_previewParticle**: resource_name:"particles/abilities/engineer/engineer_sentry_deploy_preview.vpcf"
- **m_strChannelLoopSound**: soundevent:"Forge.Turret.Place"
- **m_deploymentInfo**:
  - **m_previewModel**: resource_name:"models/heroes_staging/engineer/turret/turret.vmdl"
  - **m_strExtraBodygroup**: Range_Markers
  - **m_flPreviewModelScale**: 0.8
  - **m_bRequiresUpNormal**: 1
  - **m_bGroundCheck**: 1
  - **m_bPlaceFlat**: 1
- **m_projectileInfo**:
  - **m_customModel**: resource_name:"models/heroes_staging/engineer/turret/turret.vmdl"
  - **m_flProjectileModelScale**: 0.5
  - **m_flSpeed**: 600
  - **m_bHideWarningParticle**: 1
  - **m_bHideImpactParticle**: 1
  - **m_nBehaviors**: PBF_DetonateOnHitWorld
- **m_strCastAnimGraphParam**: b_Sentry
- **m_flDamageFalloffEndScale**: 0.65
- **m_vecAbilityUpgrades**:
  | m_vecPropertyUpgrades |
  | --- |
  | [{'m_strPropertyName': 'AbilityCharges', 'm_strBonus': '1'}, {'m_strPropertyName': 'MoveSlowPercent', 'm_strBonus': '25'}, {'m_strPropertyName': 'SlowDuration', 'm_strBonus': '1.3'}] |
  | [{'m_strPropertyName': 'TurretAttackRange', 'm_strBonus': '10m'}, {'m_strPropertyName': 'AttackSpeedMult', 'm_strBonus': '10'}] |
  | [{'m_strPropertyName': 'TurretDPS', 'm_strBonus': '45'}] |
- **m_InnateModifier**:
  - **subclass**:
    - **_my_subclass_name**: modifier_forge_mini_turret_innate_modifier
    - **_class**: modifier_forge_mini_turret_innate_modifier
- **m_DebuffModifier**:
  - **subclass**:
    - **_class**: modifier_slow_base
    - **_my_subclass_name**: modifier_forge_mini_turret_debuff
    - **m_sLocalizationName**: modifier_forge_mini_turret_debuff
...
- **m_AbilityTooltipDetails**:
  - **m_vecAbilityInfoSections**:
    | m_strLocString | m_vecAbilityPropertiesBlock | m_vecBasicProperties | m_strAbilityPropertyUpgradeRequired |
    | --- | --- | --- | --- |
    | #citadel_ability_shieldedsentry_desc | [{'m_vecAbilityProperties': [{'m_strImportantProperty': 'TurretDPS'}, {'m_strImportantProperty': 'TurretAttackRange'}]}] | ['TurretLifetime'] |  |
...
- **m_eAbilityActivation**: CITADEL_ABILITY_ACTIVATION_PRESS
- **m_nAbilityBehaviors**: CITADEL_ABILITY_BEHAVIOR_DEPLOY_OBJECT | CITADEL_ABILITY_BEHAVIOR_CAN_HEAL_PLAYERS | CITADEL_ABILITY_BEHAVIOR_DISPLAYS_DAMAGE_IMPACT
...
- **m_strAbilityImage**: panorama:"file://{images}/hud/abilities/engineer_resupply.psd"
- **m_deploymentInfo**:
  - **m_previewModel**: resource_name:"models/weapons/engineer/engineer_dispenser.vmdl"
  - **m_bRequiresUpNormal**: 1
  - **m_bGroundCheck**: 1
  - **m_bPlaceFlat**: 1
- **m_projectileInfo**:
  - **m_customModel**: resource_name:"models/weapons/engineer/engineer_dispenser.vmdl"
  - **m_flSpeed**: 600
  - **m_bHideWarningParticle**: 1
  - **m_bHideImpactParticle**: 1
  - **m_nBehaviors**: PBF_DetonateOnHitWorld
...
- **m_vecAbilityUpgrades**:
  | m_vecPropertyUpgrades |
  | --- |
  | [{'m_strPropertyName': 'AuraFireRateBonus', 'm_strBonus': '35'}] |
  | [{'m_strPropertyName': 'AbilityCooldown', 'm_strBonus': '-18'}] |
  | [{'m_strPropertyName': 'MaxHealthRegenPct', 'm_strBonus': '5'}] |
- **m_AuraModifier**:
  - **subclass**:
    - **_class**: modifier_mobile_resupply_aura
    - **_my_subclass_name**: modifier_mobile_resupply_aura
    - **m_sStartSound**: soundevent:"Forge.MobileResupply.Start"
    - **m_sAmbientLoopingSound**: soundevent:"Forge.MobileResupply.Aura.Thinker.Modifier.Lp"
    - **m_sExpiredSound**: soundevent:"Forge.MobileResupply.End"
    - **m_strParticleEffect**: resource_name:"particles/abilities/engineer/engineer_mobile_heal_aura.vpcf"
    ...
    - **m_modifierProvidedByAura**:
      - **subclass**:
        ...
        - **m_sAmbientLoopingSound**: soundevent:"Forge.MobileResupply.Aura.Modifier.Lp"
        - **m_sLocalizationName**: modifier_mobile_resupply
        - **m_vecAutoRegisterModifierValueFromAbilityPropertyName**:
          - AuraFireRateBonus
    - **m_bIsHidden**: True
- **m_DispenserModel**: resource_name:"models/weapons/engineer/engineer_dispenser.vmdl"
- **m_SprayParticle**: resource_name:"particles/abilities/engineer/engineer_mobile_dispenser_spray.vpcf"
- **m_DestroyedParticle**: resource_name:"particles/abilities/heavy_barrage_projectile_impact_explode.vpcf"
- **m_strMoviePreviewPath**: file://{resources}/videos/hero_abilities/ability_forge_mobile_resupply.webm
- **m_strKilledSound**: soundevent:"citadel_mobile_resupply_object.Killed"
- **m_AbilityTooltipDetails**:
  - **m_vecAbilityInfoSections**:
    | m_strLocString | m_vecAbilityPropertiesBlock | m_vecBasicProperties |
    | --- | --- | --- |
    | #citadel_ability_mobile_resupply_desc | [{'m_vecAbilityProperties': [{'m_strImportantProperty': 'ExternalBonusHealthRegen'}, {'m_strImportantProperty': 'AuraFireRateBonus', 'm_bRequiresAbilityUpgrade': True}, {'m_strImportantProperty': 'MaxHealthRegenPct', 'm_bRequiresAbilityUpgrade': True}]}] | ['HealRadius'] |

### ESlot_Signature_3

- **_class**: citadel_ability_fissure_wall
- **m_mapAbilityProperties**:
  - **AbilityCooldown**:
    - **m_strValue**: 35
    - **m_strDisableValue**: 0
  ...
  - **WallStunDuration**:
    ...
    - **m_subclassScaleFunction**:
      - **subclass**:
        - **_class**: scale_function_single_stat
        - **_my_subclass_name**: WallStunDuration_scale_function
        - **m_eSpecificStatScaleType**: ETechDuration
  - **NumWallSegments**:
    - **m_strValue**: 7
  - **TimeBetweenSegments**:
...
- **m_eAbilityActivation**: CITADEL_ABILITY_ACTIVATION_INSTANT_CAST
- **m_nAbilityBehaviors**: CITADEL_ABILITY_BEHAVIOR_DISPLAYS_DAMAGE_IMPACT | CITADEL_ABILITY_BEHAVIOR_PREVENT_BOT_USAGE
- **m_nAbilityTargetTypes**: CITADEL_UNIT_TARGET_ALL_ENEMY
- **m_eAbilitySpectatePriority**: CITADELTV_ABILITY_SPECTATE_PRIORITY_HIGH
- **m_strAbilityImage**: panorama:"file://{images}/hud/abilities/engineer_fissure_2.psd"
- **m_strCastAnimGraphParam**: b_Fissure
- **m_vecAbilityUpgrades**:
  | m_vecPropertyUpgrades |
  | --- |
  | [{'m_strPropertyName': 'StaminaReduction', 'm_strBonus': '1'}, {'m_strPropertyName': 'BonusDamagePercent', 'm_strBonus': '25'}, {'m_strPropertyName': 'DebuffDuration', 'm_strBonus': '7'}] |
  | [{'m_strPropertyName': 'AbilityCooldown', 'm_strBonus': '-15'}] |
  | [{'m_strPropertyName': 'WallStunDuration', 'm_strBonus': '1'}] |
- **m_FriendlyWallParticle**: resource_name:"particles/abilities/engineer/engineer_wall_deploy.vpcf"
- **m_EnemyWallParticle**: resource_name:"particles/abilities/engineer/engineer_wall_deploy_enemy.vpcf"
- **m_WallTravelSoundLoop**: soundevent:"Forge.FissureWall.Travel.Lp"
- **m_WallModifier**:
  - **subclass**:
    - **_class**: modifier_fissure_wall
    - **_my_subclass_name**: modifier_fissure_wall
    - **m_bIsHidden**: True
    - **m_nAttributes**: MODIFIER_ATTRIBUTE_PERMANENT | MODIFIER_ATTRIBUTE_MULTIPLE
    - **m_DebrisParticle**: resource_name:"particles/abilities/engineer/engineer_fissure_impact.vpcf"
    - **m_SpikeParticle**: resource_name:"particles/abilities/engineer/engineer_wall.vpcf"
    - **m_WallSpawnSound**: soundevent:"Forge.FissureWall.Spawn"
    - **m_EnemyVisionModifier**:
      - **subclass**:
        - **_my_subclass_name**: modifier_enemy_vision
        - **m_nEnabledStateMask**: MODIFIER_STATE_GLOW_THROUGH_WALLS_TO_ENEMY
        - **m_bIsHidden**: True
        - **_class**: modifier_base
    - **m_DebuffModifier**:
      - **subclass**:
        - **_class**: modifier_bonus_damage_percent
        - **_my_subclass_name**: modifier_bonus_damage_percent
        - **m_bSelfish**: True
        - **m_bIsHidden**: True
        - **m_strSmallIconCssClass**: fissure_wall
    ...
    - **m_SlowModifier**:
      - **subclass**:
        ...
        - **m_vecAutoRegisterModifierValueFromAbilityPropertyName**:
          - SlowPercent
    - **m_sExpiredSound**: soundevent:"Forge.FissureWall.End"
- **m_strMoviePreviewPath**: file://{resources}/videos/hero_abilities/ability_forge_fissure_wall.webm
- **m_strCastSound**: soundevent:"Forge.FissureWall.Cast"
...
- **m_AbilityTooltipDetails**:
  - **m_vecAbilityInfoSections**:
    | m_strLocString | m_vecAbilityPropertiesBlock | m_vecBasicProperties |
    | --- | --- | --- |
    | #citadel_ability_fissure_wall_desc | [{'m_strPropertiesTitleLocString': '', 'm_vecAbilityProperties': [{'m_strImportantProperty': 'Damage'}, {'m_strImportantProperty': 'SlowPercent'}, {'m_strImportantProperty': 'StatusEffectStun', 'm_strStatusEffectValue': 'WallStunDuration', 'm_bRequiresAbilityUpgrade': True}]}] | ['MinRange', 'WallImpactRange', 'SlowDuration'] |
    | #citadel_ability_fissure_wall_t1_desc | [{'m_strPropertiesTitleLocString': '#Citadel_AbilityProperty_OnHit', 'm_vecAbilityProperties': [{'m_strImportantProperty': 'DebuffDuration'}, {'m_strImportantProperty': 'BonusDamagePercent'}]}] |  |

### ESlot_Signature_4

- **_class**: citadel_ability_rocket_barrage
- **m_mapAbilityProperties**:
  - **AbilityCooldown**:
    - **m_strValue**: 100
    - **m_strDisableValue**: 0
  ...
  - **DamagePerRocket**:
    ...
    - **m_subclassScaleFunction**:
      - **subclass**:
        - **_class**: scale_function_tech_damage
        - **_my_subclass_name**: DamagePerRocket_scale_function
        - **m_eSpecificStatScaleType**: ETechPower
        - **m_flStatScale**: 0.3276
  - **GrenadesPerSecond**:
    - **m_strValue**: 6
  - **IntervalRampUpTime**:
    - **m_strValue**: 0.3
...
- **m_HUDPanel**:
  ...
  - **m_vecHUDElements**:
    ...
    | --- | --- | --- | --- |
    | CITADEL_ABILITY_HUD_ELEMENT_TYPE_PROGRESS | channel | file://{resources}/layout/ability_hud_elements/element_progress_bar.vxml | True |
- **_multibase**:
  - ultimate_base
- **m_bStartTrained**: False
- **m_nAbilityPointsCost**: 0
...
- **m_strAbilityChargeReadySound**: soundevent:""
- **m_skillshotMissParticle**: resource_name:"particles/abilities/skillshot_default_miss_owner.vpcf"
- **m_iUpdateTime**: 1688595425
- **m_eAbilityTargetingLocation**: CITADEL_ABILITY_TARGETING_LOCATION_GROUND
- **m_eAbilityActivation**: CITADEL_ABILITY_ACTIVATION_PRESS
- **m_nAbilityBehaviors**: CITADEL_ABILITY_BEHAVIOR_CHANNELLED | CITADEL_ABILITY_BEHAVIOR_DISPLAYS_DAMAGE_IMPACT
- **m_eAbilitySpectatePriority**: CITADELTV_ABILITY_SPECTATE_PRIORITY_MEDIUM
- **m_nAbilityTargetTypes**: CITADEL_UNIT_TARGET_ALL_ENEMY
- **m_strAbilityImage**: panorama:"file://{images}/hud/abilities/engineer_rockets.psd"
- **m_projectileInfo**:
  - **m_particle**: resource_name:"particles/abilities/engineer/engineer_barrage_projectile.vpcf"
  - **m_customModel**: resource_name:"models/w_models/weapons/w_he_grenade.vmdl"
  - **m_bHideWarningParticle**: 1
  - **m_bHideImpactParticle**: 1
  - **m_flTrackingDuration**: 1
  - **m_flTrackingStartTime**: 0.1
  - **m_flTrackingEndTime**: 0.3
  - **m_flTriggerRadius**: 3
  - **m_flSpeed**: 3500
  - **m_flUpSpeed**: 450
  - **m_LoopingSound**: soundevent:"Forge.Rocket.Barrage.Proj.Lp"
- **m_vecAbilityUpgrades**:
  | m_vecPropertyUpgrades |
  | --- |
  | [{'m_strPropertyName': 'MoveSlowPercent', 'm_strBonus': '35'}, {'m_strPropertyName': 'MoveSlowDuration', 'm_strBonus': '2.0'}] |
  | [{'m_strPropertyName': 'AbilityCooldown', 'm_strBonus': '-50'}] |
  | [{'m_strPropertyName': 'DamagePerRocket', 'm_strBonus': '30'}] |
- **m_strMoviePreviewPath**: file://{resources}/videos/hero_abilities/ability_forge_rocket_barrage.webm
- **m_BarrageModifier**:
  - **subclass**:
    - **_class**: modifier_citadel_rocket_barrage_volley
    - **_my_subclass_name**: modifier_citadel_rocket_barrage_volley
    - **m_strFireSound**: soundevent:"Forge.Rocket.Barrage.Fire"
    - **m_vecSetAndTrackedAnimGraphParams**:
      | m_strName | m_strSetValue | m_strRestoreValue |
      | --- | --- | --- |
      | b_rocket_barrage | 1 | 0 |
      |  |  |  |
- **m_MoveSlowModifier**:
  - **subclass**:
    - **_class**: modifier_slow_base
    - **_my_subclass_name**: modifier_forge_rocket_barrage_slow
    - **m_bIsHidden**: True
    - **m_vecAutoRegisterModifierValueFromAbilityPropertyName**:
      - MoveSlowPercent
- **m_strExplodeSound**: soundevent:"Forge.Rocket.Barrage.Explode"
- **m_ImpactParticle**: resource_name:"particles/abilities/engineer/engineer_barrage_explode.vpcf"
- **m_AbilityTooltipDetails**:
  - **m_vecAbilityInfoSections**:
    | m_strLocString | m_vecAbilityPropertiesBlock | m_vecBasicProperties |
    | --- | --- | --- |
    | #citadel_ability_rocket_barrage_desc | [{'m_vecAbilityProperties': [{'m_strImportantProperty': 'DamagePerRocket'}, {'m_strImportantProperty': 'GrenadesPerSecond'}, {'m_strImportantProperty': 'ExplosionRadius'}]}] | ['MinDistance', 'AbilityChannelTime'] |
- **m_strChannelLoopSound**: soundevent:"Forge.Rocket.Barrage.Channel.Lp"
- **m_strCastSound**: soundevent:"Forge.Rocket.Barrage.Channel.End"
- **m_cameraSequenceSelected**:
  - **m_vecVertOffsetOperations**:
    | m_eCameraOperation | m_bValuesAreRelative | m_bSpringToDefault | m_flSpringTarget |
    | --- | --- | --- | --- |
    | k_ECameraOp_Spring | False | False | 100.0 |
    | k_ECameraOp_Maintain |  |  |  |
  - **m_vecDistanceOperations**:
    | m_eCameraOperation | m_bValuesAreRelative | m_bSpringToDefault | m_flSpringTarget |
    | --- | --- | --- | --- |
    | k_ECameraOp_Spring | False | False | 300.0 |
    | k_ECameraOp_Maintain |  |  |  |
- **m_flMoveSpeedReductionPct**: 54.0
