  ...
  - **MaxDamage**:
    ...
    - **m_subclassScaleFunction**:
      - **subclass**:
        ...
        - **_my_subclass_name**: MaxDamage_scale_function
...
- **m_flChargeForMaxDamage**: 1.5
- **m_flMinDamagePercent**: 0.25
- **m_vecAbilityUpgrades**:
  | m_vecPropertyUpgrades |
  | --- |
  | [{'m_strPropertyName': 'AbilityCooldown', 'm_strBonus': '0'}] |
  | [{'m_strPropertyName': 'AbilityCooldown', 'm_strBonus': '0'}] |
  | [{'m_strPropertyName': 'AbilityCooldown', 'm_strBonus': '0'}] |
...
- **m_strExplodeSound**: soundevent:"Ability.GhostSoldier.BloodBomb.Explode"
- **m_ChargeBombModifier**:
  - **subclass**:
    - **_class**: modifier_charged_bomb
    - **_my_subclass_name**: modifier_charged_bomb
    - **m_strBeepSound**: soundevent:"Ability.GhostSoldier.BloodBomb.Beep"
    - **m_eHudDisplayLocation**: DISPLAY_HUD_CENTER
    - **m_sLocalizationName**: modifier_charged_bomb
    - **m_bReverseHudProgressBar**: True
- **m_AbilityTooltipDetails**:
  - **m_vecAbilityInfoSections**:
    | m_strLocString | m_vecAbilityPropertiesBlock |
    | --- | --- |
    | #ability_rollermine_desc | [{'m_vecAbilityProperties': [{'m_strImportantProperty': 'ExplosionDamage'}, {'m_strImportantProperty': 'ExplosionRadius'}]}] |
- **m_vecDependentAbilities**:
  - ability_charged_bomb_throw

### ESlot_Signature_2

- **_class**: ability_bomber_ability02
- **m_mapAbilityProperties**:
  - **AbilityCooldown**:
    - **m_strValue**: 25
    - **m_strDisableValue**: 0
...
- **m_AbilityTooltipDetails**:
  - **m_vecAbilityInfoSections**:
    | m_strLocString | m_vecAbilityPropertiesBlock |
    | --- | --- |
    | #ability_bomber_ability02_desc | [{'m_vecAbilityProperties': []}] |

### ESlot_Signature_3

- **_class**: ability_bomber_ability03
- **m_mapAbilityProperties**:
  - **AbilityCooldown**:
    - **m_strValue**: 25
    - **m_strDisableValue**: 0
...
- **m_AbilityTooltipDetails**:
  - **m_vecAbilityInfoSections**:
    | m_strLocString | m_vecAbilityPropertiesBlock |
    | --- | --- |
    | #ability_bomber_ability03_desc | [{'m_vecAbilityProperties': []}] |

### ESlot_Signature_4

- **_class**: ability_bomber_ult
- **m_mapAbilityProperties**:
  - **AbilityCooldown**:
    - **m_strValue**: 120
    - **m_strDisableValue**: 0
...
- **m_AbilityTooltipDetails**:
  - **m_vecAbilityInfoSections**:
    | m_strLocString | m_vecAbilityPropertiesBlock |
    | --- | --- |
    | #ability_bomber_ult | [{'m_vecAbilityProperties': [{'m_strImportantProperty': 'AbilityCooldown'}]}] |
