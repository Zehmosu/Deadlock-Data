...
- **m_WeaponInfo**:
  ...
  - **m_szBulletTravelTracerParticle**: resource_name:"particles/weapon_fx/astro/astro_tracer.vpcf"
  - **m_szMuzzleFlashEffectName**: resource_name:"particles/weapon_fx/astro/astro_muzzle_flash.vpcf"
  - **m_strShootSound**: soundevent:"Astro.Wpn.Fire"
  - **m_strBulletWhizSound**: soundevent:"Astro.Wpn.Whizby"
  ...
  - **m_flShootSpreadPenaltyDecayDelay**: 0.1
  ...
  - **m_strZoomInSound**: soundevent:"Astro.ZoomIn"
  - **m_strZoomOutSound**: soundevent:"Astro.ZoomOut"
  - **m_bBulletShouldUseVerlet**: True
  - **m_flRecoilRecoveryDelayFactor**: 0.75
  ...
  - **m_StandingShootSpreadPenalty**:
    - 0.0
    - 0.5
  - **m_flRecoilShotIndexRecoveryTimePerShot**: 0.2
  - **m_strBulletImpactSound**: soundevent:"Astro.Wpn.Impact"
  - **m_flBulletDamage**: 32.2
- **_multibase**:
  - hero_weapon_base
...
- **_class**: ability_explosive_barrel
- **m_mapAbilityProperties**:
  - **AbilityCooldown**:
    - **m_strValue**: 30
    - **m_strDisableValue**: 0
...
- **m_HUDPanel**:
  ...
  - **m_vecHUDElements**:
    ...
    | --- | --- | --- |
    | CITADEL_ABILITY_HUD_ELEMENT_TYPE_PROGRESS | cast | panorama:"file://{resources}/layout/ability_hud_elements/element_empty.vxml" |
- **_multibase**:
  - signature_base
...
- **m_iUpdateTime**: 1720039438
- **m_eAbilityTargetingLocation**: CITADEL_ABILITY_TARGETING_LOCATION_NONE
- **m_eAbilityActivation**: CITADEL_ABILITY_ACTIVATION_INSTANT_CAST
- **m_eAbilitySpectatePriority**: CITADELTV_ABILITY_SPECTATE_PRIORITY_MEDIUM
- **m_nAbilityTargetTypes**: CITADEL_UNIT_TARGET_ALL_ENEMY
- **m_nAbilityBehaviors**: CITADEL_ABILITY_BEHAVIOR_PROJECTILE | CITADEL_ABILITY_BEHAVIOR_NO_TARGET | CITADEL_ABILITY_BEHAVIOR_DISPLAYS_DAMAGE_IMPACT
- **m_strAbilityImage**: panorama:"file://{images}/hud/abilities/inferno_bomb_v2.psd"
- **m_strCastAnimGraphParam**: b_ExplosiveBarrel
- **m_projectileInfo**:
  - **m_flGravityScale**: 1
  - **m_flUpSpeed**: 20
  - **m_flSpeed**: 400
  - **m_flVerticalAimBias**: 0
  - **m_bHideImpactParticle**: 1
  - **m_bHideWarningParticle**: 1
  - **m_flPhysicsRadius**: 22
  - **m_flTriggerRadius**: 30
  - **m_customModel**: resource_name:"models/abilities/astro_explosive.vmdl"
  - **m_nBehaviors**: PBF_NotTurnTowardVelocity
  - **m_particle**: resource_name:"particles/abilities/astro/astro_barrel_rope_burn.vpcf"
- **m_vecAbilityUpgrades**:
  | m_vecPropertyUpgrades |
  | --- |
  | [{'m_strPropertyName': 'AbilityCharges', 'm_strBonus': '1'}] |
  | [{'m_strPropertyName': 'BarrelDamage', 'm_strBonus': '140'}] |
  | [{'m_strPropertyName': 'AbilityCooldown', 'm_strBonus': '-10'}, {'m_strPropertyName': 'MinTimeBeforeDestroy', 'm_strBonus': '-1'}, {'m_strPropertyName': 'ArmTime', 'm_strBonus': '-1'}] |
- **m_AbilityTooltipDetails**:
  - **m_vecAbilityInfoSections**:
    | m_strLocString | m_vecAbilityPropertiesBlock |
    | --- | --- |
    | #ability_explosive_barrel_desc | [{'m_vecAbilityProperties': [{'m_strImportantProperty': 'BarrelDamage'}, {'m_strImportantProperty': 'ArmTime'}]}] |
- **m_strCastSound**: soundevent:"Astro.ExplosiveBarrel.Cast"
- **m_BarrelModel**: resource_name:"models/abilities/astro_explosive.vmdl"
- **m_BarrelExplodeParticle**: resource_name:"particles/abilities/astro/astro_barrel_explode.vpcf"
- **m_MirvExplodeParticle**: resource_name:"particles/abilities/engineer/engineer_barrage_explode.vpcf"
- **m_BarrelBurnParticle**: resource_name:""
- **m_strExplodeSound**: soundevent:"Ability.Astro.ExpBarrels.Explode"
- **m_strMirvExplodeSound**: soundevent:"Ability.Astro.ExpBarrels.Explode"
- **m_strRiccochetSound**: soundevent:"Astro.ExpBarrels.Bullet.Ricochet"
- **m_strBarrelSoundLp**: soundevent:"Ability.Astro.ExpBarrels.Lp"
- **m_strBarrelLaunchSound**: soundevent:"Ability.Astro.ExpBarrels.Launch"
- **m_strMoviePreviewPath**: file://{resources}/videos/hero_abilities/astro_explosive_barrel.webm
- **m_strBarrelMeleedSound**: soundevent:""

### ESlot_Signature_2

- **_class**: ability_bounce_pad
- **m_mapAbilityProperties**:
  - **AbilityCooldown**:
    - **m_strValue**: 35
    - **m_strDisableValue**: 0
  ...
  - **AirControlPercent**:
    - **m_strValue**: 100
    - **m_strCSSClass**: move_speed
    - **m_eProvidedPropertyType**: MODIFIER_VALUE_AIR_CONTROL_PERCENT
  - **AirControlAccelPercent**:
    - **m_strValue**: 50
    - **m_strCSSClass**: move_speed
    - **m_eProvidedPropertyType**: MODIFIER_VALUE_AIR_CONTROL_ACCEL_PERCENT
  - **MinAirTimeForStomp**:
    - **m_strValue**: 0.2
    - **m_strCSSClass**: duration
  - **Radius**:
    ...
    - **m_subclassScaleFunction**:
      - **subclass**:
        - **_class**: scale_function_single_stat
        - **_my_subclass_name**: StompRadius_scale_function
        - **m_eSpecificStatScaleType**: ETechRadius
  ...
  - **StompStunDuration**:
    ...
    - **m_subclassScaleFunction**:
      - **subclass**:
        - **_class**: scale_function_single_stat
        - **_my_subclass_name**: StompStunDuration_scale_function
        - **m_eSpecificStatScaleType**: ETechDuration
  - **SpeedOnLand**:
    - **m_strValue**: 0m
    - **m_eDisplayUnits**: EDisplayUnit_MetersPerSecond
  ...
  - **SpeedOnLandDuration**:
    ...
    - **m_subclassScaleFunction**:
      - **subclass**:
        - **_class**: scale_function_single_stat
        - **_my_subclass_name**: SpeedOnLandDuration_scale_function
        - **m_eSpecificStatScaleType**: ETechDuration
- **m_bitsPostCastEnabledStateMask**: MODIFIER_STATE_BUSY_WITH_ACTION
- **_editor**:
  - **folder_name**: Hero Astro
...
- **m_strAbilityChargeReadySound**: soundevent:""
- **m_skillshotMissParticle**: resource_name:"particles/abilities/skillshot_default_miss_owner.vpcf"
- **m_iUpdateTime**: 1670632337
- **m_eAbilityTargetingLocation**: CITADEL_ABILITY_TARGETING_LOCATION_SELF
- **m_eAbilityTargetingShape**: CITADEL_ABILITY_TARGETING_SHAPE_CIRCLE
- **m_eAbilityActivation**: CITADEL_ABILITY_ACTIVATION_INSTANT_CAST
- **m_nAbilityBehaviors**: CITADEL_ABILITY_BEHAVIOR_DISPLAYS_DAMAGE_IMPACT | CITADEL_ABILITY_BEHAVIOR_MOVEMENT
- **m_nAbilityTargetTypes**: CITADEL_UNIT_TARGET_ALL_ENEMY
- **m_strAbilityImage**: panorama:"file://{images}/hud/abilities/astro/bounce_pad.psd"
- **m_strCastAnimGraphParam**: b_BouncePad
- **m_previewParticle**: resource_name:"particles/abilities/sticky_grenade_projectile.vpcf"
- **m_deploymentInfo**:
  - **m_previewModel**: resource_name:"models/particle/cowboy_launchpad.vmdl"
  - **m_bRequiresUpNormal**: 1
- **m_vecAbilityUpgrades**:
  | m_vecPropertyUpgrades |
  | --- |
  | [{'m_strPropertyName': 'SpeedOnLand', 'm_strBonus': '4m'}, {'m_strPropertyName': 'SpeedOnLandDuration', 'm_strBonus': '4'}] |
  | [{'m_strPropertyName': 'StompDamage', 'm_strBonus': '100'}, {'m_strPropertyName': 'StompDamage', 'm_strBonus': 1.04832, 'm_eUpgradeType': 'EAddToScale'}] |
  | [{'m_strPropertyName': 'StompStunDuration', 'm_strBonus': '1.25'}] |
- **m_strCastSound**: soundevent:""
- **m_strCastDelaySound**: soundevent:"Astro.BouncePad.CastDelay"
- **m_BounceModifier**:
  - **subclass**:
    - **_class**: modifier_citadel_bounce_pad_stomp
    - **_my_subclass_name**: modifier_citadel_bounce_pad_stomp
    - **m_strImpactSound**: soundevent:"Ability.Astro.BouncePad.Impact"
    - **m_StompParticle**: resource_name:"particles/abilities/astro/astro_bounce_pad_stomp.vpcf"
    - **m_strParticleStatusEffect**: resource_name:""
    - **m_strParticleEffect**: resource_name:"particles/abilities/astro/astro_bounce_pad_hero.vpcf"
- **m_AllyBounceModifier**:
  - **subclass**:
    - **_class**: modifier_bounce_pad_ally
...
- **m_SpeedOnLandModifier**:
  - **subclass**:
    - **_class**: modifier_base
    - **_my_subclass_name**: speed_on_land
    - **m_strParticleStatusEffect**: resource_name:""
    ...
    - **m_vecAutoRegisterModifierValueFromAbilityPropertyName**:
      - SpeedOnLand
    - **m_strParticleEffect**: resource_name:"particles/abilities/kali/kali_speed_boost_buff.vpcf"
- **m_strMoviePreviewPath**: file://{resources}/videos/hero_abilities/astro_bounce_pad.webm
- **m_AbilityTooltipDetails**:
  - **m_vecAbilityInfoSections**:
    | m_strLocString | m_vecAbilityPropertiesBlock | m_vecBasicProperties |
    | --- | --- | --- |
    | #ability_bounce_pad_desc | [{'m_vecAbilityProperties': [{'m_strImportantProperty': 'StompDamage'}]}] | ['AirControlPercent'] |

### ESlot_Signature_3

- **_class**: ability_hat_trick
- **m_mapAbilityProperties**:
  - **AbilityCooldown**:
    - **m_strValue**: 20
    - **m_strDisableValue**: 0
...
- **m_WeaponInfo**:
  - **m_BulletSpeedCurve**:
    ...
    - **m_vDomainMaxs**:
      - 100.0
      - 8000.0
  - **m_szBulletTravelTracerParticle**: resource_name:"particles/abilities/astro/astro_trick_shot_fired_projectile.vpcf"
...
- **m_HUDPanel**:
  - **m_vecButtonHints**:
    ...
    | --- | --- | --- | --- |
    | #AbilityButtonHint_HatTrickFire | EButtonSide_Right | EButtonHint_Attack | hint_speed |
    | #AbilityButtonHint_HatTrickCancel | EButtonSide_Right | EButtonHint_Cancel | channel |
  - **m_vecHUDElements**:
    | m_eType | m_strContext | m_Layout |
    | --- | --- | --- |
...
- **m_vecAbilityUpgrades**:
  | m_vecPropertyUpgrades |
  | --- |
  | [{'m_strPropertyName': 'Damage', 'm_strBonus': '50'}] |
  | [{'m_strPropertyName': 'AbilityCooldown', 'm_strBonus': '-10'}] |
  | [{'m_strPropertyName': 'SlowPercent', 'm_strBonus': '30'}] |
- **m_strCastDelaySound**: soundevent:"Archer.GuidedArrow.Cast"
- **m_strExplodeSound**: soundevent:"Archer.GuidedArrow.Impact"
- **m_ExplosionParticle**: resource_name:"particles/abilities/astro/astro_trick_shot_projectile_impact.vpcf"
- **m_DebuffModifier**:
  - **subclass**:
...
- **m_AbilityTooltipDetails**:
  - **m_vecAbilityInfoSections**:
    | m_strLocString | m_vecAbilityPropertiesBlock |
    | --- | --- |
    | #ability_hat_trick_desc | [{'m_vecAbilityProperties': [{'m_strImportantProperty': 'Damage'}, {'m_strImportantProperty': 'SlowPercent'}, {'m_strImportantProperty': 'DebuffDuration'}]}] |
- **m_ProjectileModel**: resource_name:"models/heroes_staging/astro/astro_hat.vmdl"

### ESlot_Signature_4

- **_class**: ability_gravity_lasso
- **m_mapAbilityProperties**:
  - **AbilityCooldown**:
    - **m_strValue**: 150
    - **m_strDisableValue**: 0
...
- **m_strAbilityImage**: panorama:"file://{images}/hud/abilities/astro/gravity_lasso.psd"
- **m_previewParticle**: resource_name:"particles/abilities/astro/astro_lasso_preview.vpcf"
- **m_vecAbilityUpgrades**:
  | m_vecPropertyUpgrades |
  | --- |
  | [{'m_strPropertyName': 'AbilityDuration', 'm_strBonus': '0.6'}] |
  | [{'m_strPropertyName': 'AbilityCooldown', 'm_strBonus': '-60'}] |
  | [{'m_strPropertyName': 'GrabExtraTargets', 'm_strBonus': '1'}, {'m_strPropertyName': 'ExtraTargetConeAngle', 'm_strBonus': '60'}] |
- **m_strCastSound**: soundevent:"Astro.Lasso.Cast"
- **m_strCastAnimGraphParam**: b_GravityLassoCast
- **m_GravityLassoTarget**:
  - **subclass**:
    - **_my_subclass_name**: modifier_citadel_gravity_lasso_enemy
    - **_class**: modifier_citadel_gravity_lasso_enemy
    - **m_eTimeScaleSource**: MODIFIER_TIME_SCALE_USE_CASTER
    - **m_LassoEffect**: resource_name:"particles/abilities/astro/astro_lasso.vpcf"
    - **m_cameraSequenceCreated**:
      - **m_vecDistanceOperations**:
        ...
        |  |  |  | k_ECameraOp_Maintain |
    - **m_sAmbientLoopingSound**: soundevent:"Ability.Astro.Lasso.Captured.Lp"
    - **m_OnCreateResponse**:
      - **m_nConcept**: TLK_CITADEL_INTERACT_WITH_ABILITY
      - **m_Criteria**:
        - **action**: is_lasso_target
      - **m_nSpeakerType**: MODIFIER_RR_SPEAKER_PARENT
    - **m_flLingeringAssistWindow**: 3.0
    - **m_bIsHidden**: False
    - **m_eHudDisplayLocation**: DISPLAY_HUD_CENTER
- **m_GravityLassoSelf**:
  - **subclass**:
    - **_class**: modifier_citadel_gravity_lasso_self
    - **_my_subclass_name**: modifier_citadel_gravity_lasso_self
    - **m_eTimeScaleSource**: MODIFIER_TIME_SCALE_USE_CASTER
    - **m_bIsHidden**: True
- **m_strMoviePreviewPath**: file://{resources}/videos/hero_abilities/astro_gravity_lasso.webm
- **m_AbilityTooltipDetails**:
  - **m_vecAbilityInfoSections**:
    | m_strLocString | m_vecAbilityPropertiesBlock | m_vecBasicProperties |
    | --- | --- | --- |
    | #ability_gravity_lasso_desc | [{'m_vecAbilityProperties': [{'m_strImportantProperty': 'ExtraTargetConeAngle'}]}] | [] |
