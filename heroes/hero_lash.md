...
- **m_WeaponInfo**:
  ...
  - **m_szMuzzleFlashEffectName**: resource_name:"particles/weapon_fx/lash/lash_muzzle_flash.vpcf"
  - **m_strShootSound**: soundevent:"Lash.Wpn.Fire"
  - **m_strBulletWhizSound**: soundevent:"Lash.Wpn.BulletWhizby"
  ...
  - **m_StandingMoveSpreadPenalty**:
    - 0.0
    - 0.3
  - **m_strBulletImpactSound**: soundevent:"Lash.Wpn.Impact"
  - **m_flBulletDamage**: 10
- **_multibase**:
  - hero_weapon_base
...
- **_class**: citadel_ability_lash_down_strike
- **m_mapAbilityProperties**:
  - **AbilityCooldown**:
    - **m_strValue**: 18
    - **m_strDisableValue**: 0
  ...
  - **StompDamage**:
    ...
    - **m_subclassScaleFunction**:
      - **subclass**:
        ...
        - **_my_subclass_name**: StompDamage_scale_function
  ...
  - **StompDamagePerMeterPrimary**:
    ...
    - **m_subclassScaleFunction**:
      - **subclass**:
        - **_class**: scale_function_tech_damage
        - **_my_subclass_name**: StompDamagePerMeterPrimary_scale_function
        - **m_flStatScale**: 0.0451
  - **StompDamagePerMeterSecondary**:
    ...
    - **m_subclassScaleFunction**:
      - **subclass**:
        - **_class**: scale_function_tech_damage
        - **_my_subclass_name**: StompDamagePerMeterSecondary_scale_function
        - **m_flStatScale**: 0.00875
...
- **m_strAbilityImage**: panorama:"file://{images}/hud/abilities/lash/lash_death_slam.psd"
- **m_iUpdateTime**: 1667954121
- **m_vecAbilityUpgrades**:
  | m_vecPropertyUpgrades |
  | --- |
  | [{'m_strPropertyName': 'AbilityCooldown', 'm_strBonus': '-10'}] |
  | [{'m_strPropertyName': 'EnemySlowPct', 'm_strBonus': '50'}, {'m_strPropertyName': 'SlowDuration', 'm_strBonus': '3'}, {'m_strPropertyName': 'StompBounceHeight', 'm_strBonus': '400'}] |
  | [{'m_strPropertyName': 'StompDamagePerMeterPrimary', 'm_strBonus': '0.035', 'm_eUpgradeType': 'EAddToScale', 'm_eScaleStatFilter': 'ETechPower'}, {'m_strPropertyName': 'StompDamagePerMeterPrimary', 'm_strBonus': '113', 'm_eUpgradeType': 'EMultiplyBase'}, {'m_strPropertyName': 'StompDamagePerMeterSecondary', 'm_strBonus': '0.00875', 'm_eUpgradeType': 'EAddToScale', 'm_eScaleStatFilter': 'ETechPower'}, {'m_strPropertyName': 'StompDamagePerMeterSecondary', 'm_strBonus': '113', 'm_eUpgradeType': 'EMultiplyBase'}] |
- **m_StompParticle**: resource_name:"particles/abilities/lash/lash_ground_strike_cone.vpcf"
- **m_StompExplosionSound**: soundevent:"Lash.A1.Ground.Strike.Impact"
- **m_ImpactModifier**:
  - **subclass**:
...
- **m_DownStrikeModifier**:
  - **subclass**:
    - **_class**: modifier_base
    - **_my_subclass_name**: modifier_lash_down_strike_embedded
    - **m_bIsHidden**: True
    - **m_sAmbientLoopingSound**: soundevent:"Lash.A1.Ground.Strike.Mod.Lp"
- **m_TargetPreviewParticle**: resource_name:"particles/abilities/lash/lash_ground_strike_preview_cone_projection_v2.vpcf"
- **m_strGroundCastAnimGraphParam**: 
- **m_strAirCastAnimGraphParam**: 
- **m_strCastAnimGraphParam**: b_DownStrike
- **m_previewParticle**: resource_name:"particles/abilities/lash/lash_death_slam_preview.vpcf"
- **m_strMoviePreviewPath**: file://{resources}/videos/hero_abilities/lash_ground_strike.webm
- **m_AbilityTooltipDetails**:
  - **m_vecAbilityInfoSections**:
    | m_strLocString | m_vecAbilityPropertiesBlock | m_vecBasicProperties |
    | --- | --- | --- |
    | #citadel_ability_lash_down_strike_desc | [{'m_vecAbilityProperties': [{'m_strImportantProperty': 'StompDamage'}, {'m_strImportantProperty': 'StompDamagePerMeterPrimary'}]}] | ['EnemySlowPct', 'SlowDuration'] |
- **m_strCastSound**: soundevent:"Lash.A1.Ground.Strike.Mod.Start"
- **m_flDamageFrustumAngle**: 120.0
- **m_flDamageFrustumHalfWidth**: 30.0
- **m_flDamageWaveSpeed**: 4000.0
- **m_flDamageTraceProbeStepDownHeight**: 128
- **m_flDamageTraceProbeStepUpHeight**: 32.0
- **m_StompLineParticle**: resource_name:"particles/abilities/lash/lash_ground_strike_v2_cone_line.vpcf"
- **m_nGroundCrackGap**: 5
...
- **m_eAbilityActivation**: CITADEL_ABILITY_ACTIVATION_INSTANT_CAST
- **m_nAbilityTargetTypes**: CITADEL_UNIT_TARGET_ALL_ENEMY
- **m_nAbilityBehaviors**: CITADEL_ABILITY_BEHAVIOR_MOVEMENT
- **m_strAbilityImage**: panorama:"file://{images}/hud/abilities/lash/lash_lash.psd"
...
- **m_BuffModifier**:
  - **subclass**:
    ...
    - **m_bIsHidden**: True
    - **m_strParticleEffect**: resource_name:"particles/abilities/lash/lash_pull_weapon_buff.vpcf"
    - **m_vecAutoRegisterModifierValueFromAbilityPropertyName**:
      - WeaponDamageBonus
      - WeaponFireRateBonus
...
- **m_AbilityTooltipDetails**:
  - **m_vecAbilityInfoSections**:
    | m_strLocString | m_vecAbilityPropertiesBlock | m_vecBasicProperties |
    | --- | --- | --- |
    | #citadel_ability_lash_desc | [{'m_vecAbilityProperties': [{'m_strImportantProperty': 'JumpVelocity'}]}] | ['WeaponDamageBonus', 'WeaponDamageBonusDuration', 'WeaponFireRateBonus'] |

### ESlot_Signature_3

- **_class**: ability_lash_flog
- **m_mapAbilityProperties**:
  - **AbilityCooldown**:
    - **m_strValue**: 25
    - **m_strDisableValue**: 0
  ...
  - **TargetingConeAngle**:
    ...
    - **m_subclassScaleFunction**:
      - **subclass**:
        - **_class**: scale_function_single_stat
        - **_my_subclass_name**: TargetingConeAngle_scale_function
        - **m_eSpecificStatScaleType**: ETechPower
  ...
  - **EnemySlowDuration**:
    ...
    - **m_subclassScaleFunction**:
      - **subclass**:
        - **_class**: scale_function_single_stat
        - **_my_subclass_name**: EnemySlowDuration_scale_function
        - **m_eSpecificStatScaleType**: ETechDuration
  - **HealPctVsNonHeroes**:
    - **m_strValue**: 30
    ...
    - **m_subclassScaleFunction**:
      - **subclass**:
        - **_class**: scale_function_single_stat
        - **_my_subclass_name**: HealPctVsNonHeroes_scale_function
  ...
  - **HealPctVsHeroes**:
    ...
    - **m_subclassScaleFunction**:
      - **subclass**:
        - **_class**: scale_function_single_stat
        - **_my_subclass_name**: HealPctVsHeroes_scale_function
        - **m_eSpecificStatScaleType**: EHealingOutput
  - **Damage**:
    - **m_strValue**: 65
    - **m_strCSSClass**: tech_damage
...
- **m_strAbilityImage**: panorama:"file://{images}/hud/abilities/lash/lash_whip.psd"
- **m_vecAbilityUpgrades**:
  | m_vecPropertyUpgrades |
  | --- |
  | [{'m_strPropertyName': 'EnemySlowDuration', 'm_strBonus': '3'}, {'m_strPropertyName': 'EnemySlowPct', 'm_strBonus': '35'}] |
  | [{'m_strPropertyName': 'AbilityCooldown', 'm_strBonus': '-15'}] |
  | [{'m_strPropertyName': 'Damage', 'm_strBonus': '105'}, {'m_strPropertyName': 'FireRateSlow', 'm_strBonus': '35'}] |
- **m_strCastSound**: soundevent:"Lash.A3.Flog.Cast"
- **m_strCastAnimGraphParam**: b_LashFlog
- **m_strMoviePreviewPath**: file://{resources}/videos/hero_abilities/lash_flog.webm
- **m_FlogDebuffModifier**:
  - **subclass**:
    - **_class**: modifier_lash_flog_debuff
    - **_my_subclass_name**: modifier_lash_flog_debuff
    - **m_FlogDebuffParticle**: resource_name:"particles/generic/generic_slow_debuff.vpcf"
    - **m_bIsHidden**: True
    - **m_vecAutoRegisterModifierValueFromAbilityPropertyName**:
      - FireRateSlow
- **m_FlogLifeLeachParticle**: resource_name:"particles/abilities/lash/lash_flog_lifeleach.vpcf"
- **m_FlogParticle**: resource_name:"particles/abilities/lash/lash_flog_cast.vpcf"
- **m_AbilityTooltipDetails**:
  - **m_vecAbilityInfoSections**:
    | m_strLocString | m_vecAbilityPropertiesBlock | m_vecBasicProperties |
    | --- | --- | --- |
    | #ability_lash_flog_desc | [{'m_vecAbilityProperties': [{'m_strImportantProperty': 'Damage'}, {'m_strImportantProperty': 'HealPctVsHeroes'}, {'m_strImportantProperty': 'TargetingConeAngle'}]}] | ['HealPctVsNonHeroes', 'EnemySlowPct', 'EnemySlowDuration'] |

### ESlot_Signature_4

- **m_eAbilityType**: EAbilityType_Ultimate
- **m_nAbilityBehaviors**: CITADEL_ABILITY_BEHAVIOR_CHANNELLED | CITADEL_ABILITY_BEHAVIOR_NO_TARGET | CITADEL_ABILITY_BEHAVIOR_DISPLAYS_DAMAGE_IMPACT
- **m_eAbilityActivation**: CITADEL_ABILITY_ACTIVATION_INSTANT_CAST
- **m_mapAbilityProperties**:
  ...
  - **AbilityCastDelay**:
    ...
    - **m_strCSSClass**: cast
    - **m_bCanSetTokenOverride**: True
    - **m_strLocTokenOverride**: LashUltimateChargeTime
  - **AbilityChannelTime**:
    - **m_strValue**: 2
    - **m_strDisableValue**: 0
    - **m_strCSSClass**: cast
  ...
  - **ThrowDistance**:
    ...
    - **m_subclassScaleFunction**:
      - **subclass**:
        - **_my_subclass_name**: ThrowRange_scale_function
        - **_class**: scale_function_multi_stats
        - **m_vecScalingStats**:
          - ETechPower
          - ETechRange
  ...
  - **ImpactRadius**:
    ...
    - **m_subclassScaleFunction**:
      - **subclass**:
        - **_class**: scale_function_single_stat
        - **m_eSpecificStatScaleType**: ETechRange
        - **_my_subclass_name**: impact_radius
  - **NotInConeLosesLock**:
    - **m_strValue**: 1
- **_class**: citadel_ability_lash_ultimate
- **m_eAbilityTargetingShape**: CITADEL_ABILITY_TARGETING_SHAPE_CONE
- **m_flTargetingConeAngle**: 75.0
...
- **m_HUDPanel**:
  - **m_vecHUDElements**:
    ...
    | --- | --- | --- |
    | CITADEL_ABILITY_HUD_ELEMENT_TYPE_PROGRESS | lashthrow | panorama:"file://{resources}/layout/ability_hud_elements/element_converging_semi_circles.vxml" |
    | CITADEL_ABILITY_HUD_ELEMENT_TYPE_PROGRESS | cast | file://{resources}/layout/ability_hud_elements/element_progress_bar.vxml |
  - **m_vecButtonHints**:
    | m_strContext | m_eButton1 | m_eHintSide | m_strLocToken |
    | --- | --- | --- | --- |
    | throw | EButtonHint_Attack | EButtonSide_Bottom | #AbilityButtonHint_Throw |
    ...
    | deselect | EButtonHint_AbilityKey | EButtonSide_Bottom | #AbilityButtonHint_Deselect |
    | unit_target_activate | EButtonHint_AbilityKey | EButtonSide_Bottom | #AbilityButtonHint_Activate |
- **m_strApplyLockonStack**: soundevent:"Base.Sentry.Beep"
- **m_bitsPostCastEnabledStateMask**: MODIFIER_STATE_BUSY_WITH_ACTION
- **_editor**:
  - **folder_name**: Hero Lash
- **m_WeaponInfo**:
...
- **m_strAbilityChargeReadySound**: soundevent:""
- **m_skillshotMissParticle**: resource_name:"particles/abilities/skillshot_default_miss_owner.vpcf"
- **m_strAbilityImage**: panorama:"file://{images}/hud/abilities/lash/lash_counter_lash.psd"
- **m_iUpdateTime**: 1686678287
- **m_flAirDrag**: 2.0
- **m_vecAbilityUpgrades**:
  | m_vecPropertyUpgrades |
  | --- |
  | [{'m_strPropertyName': 'ThrowDistance', 'm_strBonus': '8m'}] |
  | [{'m_strPropertyName': 'ImpactDamage', 'm_strBonus': '100'}] |
  | [{'m_strPropertyName': 'AbilityCooldown', 'm_strBonus': '-60'}] |
- **m_GrappleEnemyModifier**:
  - **subclass**:
    - **_class**: modifier_lash_grapple_enemy_debuff
    - **_my_subclass_name**: modifier_lash_grapple_enemy_debuff
    - **m_ImpactParticle**: resource_name:"particles/abilities/lash/final_strike_impact.vpcf"
    - **m_GrappleParticle**: resource_name:""
    - **m_sStartSound**: soundevent:"Lash.A4.Death.Slam.Windup"
    - **m_ImpactSound**: soundevent:"Lash.A4.Death.Slam.Impact"
    - **m_cameraSequenceCreated**:
      - **m_vecDistanceOperations**:
        | m_flSpringStrength | m_flSpringMaxDuration | m_bSpringToDefault | m_flSpringTarget | m_eCameraOperation |
        | --- | --- | --- | --- | --- |
        | 3.0 | 0.0 | False | 300.0 | k_ECameraOp_Spring |
        |  |  |  |  | k_ECameraOp_Maintain |
    - **m_DebuffModifier**:
      - **subclass**:
        - **_my_subclass_name**: slow
        - **_class**: modifier_slow_base
        - **m_sLocalizationName**: citadel_ability_lash_ultimate_debuff
        - **m_bIsHidden**: True
        - **m_vecAutoRegisterModifierValueFromAbilityPropertyName**:
          - SlowPercent
    ...
    - **m_vecSetAndTrackedAnimGraphParams**:
      ...
      | --- | --- | --- |
      | b_KnockedDown | 1 | 0 |
    - **m_LaunchParticle**: resource_name:""
    - **m_RopeParticle**: resource_name:"particles/abilities/lash/lash_ultimate_throw_target_cable.vpcf"
- **m_LaunchParticle**: resource_name:"particles/abilities/lash/lash_death_slam_start.vpcf"
- **m_TargetPreviewParticle**: resource_name:"particles/ui/ui_range_finder_aoe.vpcf"
- **m_strThrowEnemyAnimGraphParam**: b_ThrowEnemy
- **m_strCastAnimSequenceName**: lash_throw_enemy_lift
- **m_strCastSound**: soundevent:"Lash.A4.Death.Slam.Cast"
- **m_strMoviePreviewPath**: file://{resources}/videos/hero_abilities/lash_death_slam.webm
- **m_GrabSound**: soundevent:"Lash.A4.Death.Slam.Grab"
- **m_MissSound**: soundevent:"Lash.A4.Death.Slam.Miss"
- **m_ThrowSound**: soundevent:"Lash.A4.Death.Slam.Throw"
- **m_UltimateCastParticle**: resource_name:"particles/abilities/lash/lash_final_strike_cast.vpcf"
- **m_strCastDelaySound**: soundevent:"Lash.A4.Death.Slam.Cast.Delay"
- **m_UltimateCastEnemyParticle**: resource_name:"particles/abilities/lash/lash_final_strike_cast_enemy.vpcf"
- **m_AbilityTooltipDetails**:
  - **m_vecAbilityInfoSections**:
    | m_strLocString | m_vecAbilityPropertiesBlock | m_vecBasicProperties |
    | --- | --- | --- |
    | #citadel_ability_lash_ultimate_desc | [{'m_vecAbilityProperties': [{'m_strImportantProperty': 'ImpactDamage'}, {'m_strImportantProperty': 'ThrowDistance'}]}] | ['SlowPercent', 'SlowDuration', 'AbilityCastDelay'] |
- **m_GrappleTargetModifier**:
  - **subclass**:
    - **_my_subclass_name**: target
    - **_class**: modifier_lash_grapple_target
    - **m_RopeParticle**: resource_name:"particles/abilities/lash/lash_ultimate_lock_on_cable.vpcf"
    - **m_sStartSound**: soundevent:"Lash.Lash.Impact"
...
- **m_cameraSequenceCastStart**:
  - **m_vecDistanceOperations**:
    ...
    | --- | --- | --- | --- |
    | k_ECameraOp_Spring | True | False | -50.0 |
    | k_ECameraOp_Maintain |  |  |  |
  - **m_vecFOVOperations**:
    | m_eCameraOperation | m_bValuesAreRelative | m_bSpringToDefault | m_flSpringTarget |
    | --- | --- | --- | --- |
    | k_ECameraOp_Spring | True | False | 10.0 |
    | k_ECameraOp_Maintain |  |  |  |
- **m_cameraSequenceChannelStart**:
  - **m_vecDistanceOperations**:
    | m_eCameraOperation | m_flMaintainDuration |
    | --- | --- |
    | k_ECameraOp_Maintain | 999.0 |
  - **m_vecFOVOperations**:
    | m_eCameraOperation | m_flMaintainDuration |
    | --- | --- |
    | k_ECameraOp_Maintain | 99.0 |
- **m_TargetModifier**:
  - **subclass**:
    - **_class**: modifier_lash_grapple_target
    - **m_strParticleEffect**: resource_name:""
    - **m_strParticleStatusEffect**: resource_name:""
    - **m_strScreenParticleEffect**: resource_name:""
    - **_my_subclass_name**: lockon
    - **m_bIsHidden**: True
    - **m_LockingOnParticle**: resource_name:"particles/abilities/lash/lash_ultimate_lock_on_cable.vpcf"
    - **m_LockedOnParticle**: resource_name:"particles/abilities/lash/lash_ultimate_locked_cable_taut.vpcf"
